...
module AUCoreTestKit
  module AUCoreV300_BALLOT1
    class CompositionPatientDateSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(SHALL) Server returns valid results for Composition search by patient + date'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/CapabilityStatement/au-core-responder)
      ...
      id :au_core_v300_ballot1_composition_patient_date_search_test
      input :patient_ids,
            title: 'Patient IDs',
