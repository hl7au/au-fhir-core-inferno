...
module AUCoreTestKit
  module AUCoreV300_BALLOT1
    class CompositionDateSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(MAY) Server returns valid results for Composition search by date'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/CapabilityStatement/au-core-responder)
      ...
      id :au_core_v300_ballot1_composition_date_search_test
      optional
