...
module AUCoreTestKit
  module AUCoreV300_BALLOT1
    class CompositionReferenceResolutionTest < Inferno::Test
      include InfernoSuiteGenerator::ReferenceResolutionTest

      title 'MustSupport references within Composition resources are valid'
      description %(
      ...
      id :au_core_v300_ballot1_composition_reference_resolution_test
