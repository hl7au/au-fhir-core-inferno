...
require_relative 'diagnostic_report/diagnostic_report_id_search_test'
require_relative 'diagnostic_report/diagnostic_report_identifier_search_test'
...
require_relative 'diagnostic_report/diagnostic_report_patient_category_status_search_test'
...
require_relative 'diagnostic_report/diagnostic_report_patient_chain_search_test'
require_relative 'diagnostic_report/diagnostic_report_patient_ihi_chain_search_test'
require_relative 'diagnostic_report/diagnostic_report_patient_medicare_chain_search_test'
require_relative 'diagnostic_report/diagnostic_report_patient_dva_chain_search_test'
...
specified in the AU Core v3.0.0-ballot1 Implementation Guide.
...
read succeeds.
      ...
      id :au_core_v300_ballot1_diagnostic_report
      run_as_group
      ...
      test from: :au_core_v300_ballot1_diagnostic_report_patient_search_test
      test from: :au_core_v300_ballot1_diagnostic_report__id_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_identifier_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_category_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_code_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_date_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_status_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_patient_category_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_patient_category_date_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_patient_category_status_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_patient_code_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_patient_status_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_patient_code_date_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_patient_chain_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_patient_ihi_chain_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_patient_medicare_chain_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_patient_dva_chain_search_test
      test from: :au_core_v300_ballot1_diagnostic_report_read_test
      test from: :au_core_v300_ballot1_diagnostic_report_validation_test
      test from: :au_core_v300_ballot1_diagnostic_report_must_support_test
      test from: :au_core_v300_ballot1_diagnostic_report_reference_resolution_test
    end
  end
end
