...
read succeeds.
      ...
      id :au_core_v300_ballot1_composition
      run_as_group
      ...
      test from: :au_core_v300_ballot1_composition_patient_search_test
      test from: :au_core_v300_ballot1_composition_type_search_test
      test from: :au_core_v300_ballot1_composition_date_search_test
      test from: :au_core_v300_ballot1_composition_author_search_test
      test from: :au_core_v300_ballot1_composition_patient_type_search_test
      test from: :au_core_v300_ballot1_composition_patient_author_search_test
      test from: :au_core_v300_ballot1_composition_patient_date_search_test
      test from: :au_core_v300_ballot1_composition_patient_chain_search_test
      test from: :au_core_v300_ballot1_composition_patient_ihi_chain_search_test
      test from: :au_core_v300_ballot1_composition_patient_medicare_chain_search_test
      test from: :au_core_v300_ballot1_composition_patient_dva_chain_search_test
      test from: :au_core_v300_ballot1_composition_read_test
      test from: :au_core_v300_ballot1_composition_validation_test
      test from: :au_core_v300_ballot1_composition_must_support_test
      test from: :au_core_v300_ballot1_composition_reference_resolution_test
    end
  end
end
