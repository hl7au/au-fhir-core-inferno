...
module AUCoreTestKit
  module AUCoreV300_BALLOT1
    class MedicationDispenseValidationTest < Inferno::Test
      ...
      id :au_core_v300_ballot1_medication_dispense_validation_test
      title 'MedicationDispense resources returned during previous tests conform to the AU Core MedicationDispense'
      description %(
