...
module AUCoreTestKit
  module AUCoreV300_BALLOT1
    class MedicationDispensePatientStatusSearchTest < Inferno::Test
      ...
      title '(SHOULD) Server returns valid results for MedicationDispense search by patient + status'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/CapabilityStatement/au-core-responder)
      ...
      id :au_core_v300_ballot1_medication_dispense_patient_status_search_test
      optional
