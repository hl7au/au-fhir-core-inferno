...
module AUCoreTestKit
  module AUCoreV300_BALLOT1
    class DiagnosticReportPatientCategorySearchTest < Inferno::Test
      ...
      title '(SHALL) Server returns valid results for DiagnosticReport search by patient + category'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/CapabilityStatement/au-core-responder)
      ...
      id :au_core_v300_ballot1_diagnostic_report_patient_category_search_test
      input :patient_ids,
            title: 'Patient IDs',
