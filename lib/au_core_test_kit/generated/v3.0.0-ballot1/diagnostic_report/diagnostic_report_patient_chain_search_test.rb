...
module AUCoreTestKit
  module AUCoreV300_BALLOT1
    class DiagnosticReportPatientChainSearchTest < Inferno::Test
      include InfernoSuiteGenerator::ChainedSearchTest

      title '(SHOULD) Server returns valid results for DiagnosticReport search by patient (chained parameters)'
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/CapabilityStatement/au-core-responder)
      ...
      id :au_core_v300_ballot1_diagnostic_report_patient_chain_search_test
