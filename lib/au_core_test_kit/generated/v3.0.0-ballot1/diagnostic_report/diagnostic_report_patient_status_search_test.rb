...
module AUCoreTestKit
  module AUCoreV300_BALLOT1
    class DiagnosticReportPatientStatusSearchTest < Inferno::Test
      ...
      title '(SHOULD) Server returns valid results for DiagnosticReport search by patient + status'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/CapabilityStatement/au-core-responder)
      ...
      id :au_core_v300_ballot1_diagnostic_report_patient_status_search_test
      optional
