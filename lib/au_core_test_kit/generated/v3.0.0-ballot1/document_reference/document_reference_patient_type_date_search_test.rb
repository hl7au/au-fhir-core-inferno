...
module AUCoreTestKit
  module AUCoreV300_BALLOT1
    class DocumentReferencePatientTypeDateSearchTest < Inferno::Test
      ...
      title '(SHOULD) Server returns valid results for DocumentReference search by patient + type + date'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/CapabilityStatement/au-core-responder)
      ...
      id :au_core_v300_ballot1_document_reference_patient_type_date_search_test
      optional
      ...
      def self.properties
        @properties ||= InfernoSuiteGenerator::SearchTestProperties.new(
          ...
          search_param_names: %w[patient type date],
