...
module AUCoreTestKit
  module AUCoreV300_BALLOT1
    class DocumentReferencePatientTypeSearchTest < Inferno::Test
      ...
      title '(SHALL) Server returns valid results for DocumentReference search by patient + type'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/CapabilityStatement/au-core-responder)
      ...
      id :au_core_v300_ballot1_document_reference_patient_type_search_test
      input :patient_ids,
            title: 'Patient IDs',
