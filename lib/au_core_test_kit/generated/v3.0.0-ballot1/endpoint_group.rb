...
read succeeds.
      ...
      id :au_core_v300_ballot1_endpoint
      run_as_group
      ...
      test from: :au_core_v300_ballot1_endpoint_read_test
      test from: :au_core_v300_ballot1_endpoint__id_search_test
      test from: :au_core_v300_ballot1_endpoint_status_search_test
      test from: :au_core_v300_ballot1_endpoint_connection_type_search_test
      test from: :au_core_v300_ballot1_endpoint_payload_type_search_test
      test from: :au_core_v300_ballot1_endpoint_name_search_test
      test from: :au_core_v300_ballot1_endpoint_validation_test
      test from: :au_core_v300_ballot1_endpoint_must_support_test
    end
  end
end
