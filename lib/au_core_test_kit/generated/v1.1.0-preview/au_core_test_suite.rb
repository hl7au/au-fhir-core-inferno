  ...
  module AUCoreV110_PREVIEW
    class AUCoreTestSuite < Inferno::TestSuite
      ...
      description %(
        ...
        Implementation Guide](https://hl7.org.au/fhir/core/1.1.0-preview).
      ...
      fhir_resource_validator do
        igs 'hl7.fhir.au.core#1.1.0-preview'
      ...
      group do
        ...
        id :au_core_v110_preview_fhir_api

        group from: :au_core_v030_ballot_capability_statement

        group from: :au_core_v110_preview_patient

        group from: :au_core_v110_preview_bodyweight

        group from: :au_core_v110_preview_bloodpressure

        group from: :au_core_v110_preview_bodyheight

        group from: :au_core_v110_preview_diagnosticresult_path

        group from: :au_core_v110_preview_bodytemp

        group from: :au_core_v110_preview_heartrate

        group from: :au_core_v110_preview_waistcircum

        group from: :au_core_v110_preview_resprate

        group from: :au_core_v110_preview_diagnosticresult

        group from: :au_core_v110_preview_smokingstatus

        group from: :au_core_v110_preview_allergy_intolerance

        group from: :au_core_v110_preview_condition

        group from: :au_core_v110_preview_encounter

        group from: :au_core_v110_preview_immunization

        group from: :au_core_v110_preview_medication_request

        group from: :au_core_v110_preview_medication_statement

        group from: :au_core_v110_preview_procedure

        group from: :au_core_v110_preview_related_person

        group from: :au_core_v110_preview_location

        group from: :au_core_v110_preview_organization

        group from: :au_core_v110_preview_practitioner

        group from: :au_core_v110_preview_practitioner_role
