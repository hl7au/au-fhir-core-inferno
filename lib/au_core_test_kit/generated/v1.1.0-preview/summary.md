...
#### 1.21.1 (SHALL) Server returns correct Location resource from Location read interaction
<details>
...
#### 1.21.2 (SHOULD) Server returns valid results for Location search by address
<details>
...
#### 1.21.3 (SHALL) Server returns valid results for Location search by name
<details>
...
#### 1.21.4 (SHOULD) Server returns valid results for Location search by address-city
<details>
...
#### 1.21.5 (SHOULD) Server returns valid results for Location search by address-state
<details>
...
#### 1.21.6 (SHOULD) Server returns valid results for Location search by address-postalcode
<details>
...
#### 1.21.7 Location resources returned during previous tests conform to the AU Core Location
<details>
...
#### 1.21.8 All must support elements are provided in the Location resources returned
<details>
...
#### 1.21.9 MustSupport references within Location resources are valid
<details>
...
#### 1.22.1 (SHALL) Server returns correct Organization resource from Organization read interaction
<details>
...
#### 1.22.2 (SHOULD) Server returns valid results for Organization search by _id
<details>
...
#### 1.22.3 (SHOULD) Server returns valid results for Organization search by address
<details>
...
#### 1.22.4 (SHALL) Server returns valid results for Organization search by identifier
<details>
...
#### 1.22.5 (SHALL) Server returns valid results for Organization search by name
<details>
...
#### 1.22.6 (SHOULD) Server returns valid results for Organization search by identifier (HPI-O)
<details>
...
#### 1.22.7 (SHOULD) Server returns valid results for Organization search by identifier (ABN)
<details>
...
#### 1.22.8 Organization resources returned during previous tests conform to the AU Core Organization
<details>
...
#### 1.22.9 All must support elements are provided in the Organization resources returned
<details>
...
#### 1.23.1 (SHALL) Server returns correct Practitioner resource from Practitioner read interaction
<details>
...
#### 1.23.2 (SHOULD) Server returns valid results for Practitioner search by _id
<details>
...
#### 1.23.3 (SHALL) Server returns valid results for Practitioner search by identifier
<details>
...
#### 1.23.4 (SHOULD) Server returns valid results for Practitioner search by name
<details>
...
#### 1.23.5 (SHOULD) Server returns valid results for Practitioner search by identifier (HPI-I)
<details>
...
#### 1.23.6 Practitioner resources returned during previous tests conform to the AU Core Practitioner
<details>
...
#### 1.23.7 All must support elements are provided in the Practitioner resources returned
<details>
...
#### 1.24.1 (SHALL) Server returns correct PractitionerRole resource from PractitionerRole read interaction
<details>
...
#### 1.24.2 (SHOULD) Server returns valid results for PractitionerRole search by _id
<details>
...
#### 1.24.3 (SHALL) Server returns valid results for PractitionerRole search by identifier
<details>
...
#### 1.24.4 (SHALL) Server returns valid results for PractitionerRole search by practitioner
<details>
...
#### 1.24.5 (SHOULD) Server returns valid results for PractitionerRole search by specialty
<details>
...
#### 1.24.6 (SHOULD) Server returns valid results for PractitionerRole search by role
<details>
...
#### 1.24.7 (MAY) Server returns valid results for PractitionerRole search by organization
<details>
...
#### 1.24.8 (MAY) Server returns valid results for PractitionerRole multipleOr search by practitioner
<details>
...
#### 1.24.9 (MAY) Server returns valid results for PractitionerRole multipleAnd search by practitioner
<details>
...
#### 1.24.10 (SHOULD) Server returns valid results for PractitionerRole search by practitioner (chained parameters)
<details>
...
#### 1.24.11 (SHOULD) Server returns valid results for PractitionerRole search by identifier (Medicare)
<details>
...
#### 1.24.12 Server returns Practitioner resources from PractitionerRole search by _id and PractitionerRole:practitioner
<details>
...
#### 1.24.13 Server returns Practitioner resources from PractitionerRole search by identifier and PractitionerRole:practitioner
<details>
...
#### 1.24.14 Server returns Practitioner resources from PractitionerRole search by practitioner and PractitionerRole:practitioner
<details>
...
#### 1.24.15 Server returns Practitioner resources from PractitionerRole search by specialty and PractitionerRole:practitioner
<details>
...
#### 1.24.16 PractitionerRole resources returned during previous tests conform to the AU Core PractitionerRole
<details>
...
#### 1.24.17 All must support elements are provided in the PractitionerRole resources returned
<details>
...
#### 1.24.18 MustSupport references within PractitionerRole resources are valid
<details>
