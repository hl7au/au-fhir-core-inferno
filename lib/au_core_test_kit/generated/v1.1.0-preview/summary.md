...
#### 4.21.1 (SHALL) Server returns correct Location resource from Location read interaction
<details>
...
#### 4.21.2 (SHOULD) Server returns valid results for Location search by address
<details>
...
#### 4.21.3 (SHALL) Server returns valid results for Location search by name
<details>
...
#### 4.21.4 (SHOULD) Server returns valid results for Location search by address-city
<details>
...
#### 4.21.5 (SHOULD) Server returns valid results for Location search by address-state
<details>
...
#### 4.21.6 (SHOULD) Server returns valid results for Location search by address-postalcode
<details>
...
#### 4.21.7 Location resources returned during previous tests conform to the AU Core Location
<details>
...
#### 4.21.8 All must support elements are provided in the Location resources returned
<details>
...
#### 4.21.9 MustSupport references within Location resources are valid
<details>
...
#### 4.22.1 (SHALL) Server returns correct Organization resource from Organization read interaction
<details>
...
#### 4.22.2 (SHOULD) Server returns valid results for Organization search by _id
<details>
...
#### 4.22.3 (SHOULD) Server returns valid results for Organization search by address
<details>
...
#### 4.22.4 (SHALL) Server returns valid results for Organization search by identifier
<details>
...
#### 4.22.5 (SHALL) Server returns valid results for Organization search by name
<details>
...
#### 4.22.6 (SHOULD) Server returns valid results for Organization search by identifier (HPI-O)
<details>
...
#### 4.22.7 (SHOULD) Server returns valid results for Organization search by identifier (ABN)
<details>
...
#### 4.22.8 Organization resources returned during previous tests conform to the AU Core Organization
<details>
...
#### 4.22.9 All must support elements are provided in the Organization resources returned
<details>
...
#### 4.23.1 (SHALL) Server returns correct Practitioner resource from Practitioner read interaction
<details>
...
#### 4.23.2 (SHOULD) Server returns valid results for Practitioner search by _id
<details>
...
#### 4.23.3 (SHALL) Server returns valid results for Practitioner search by identifier
<details>
...
#### 4.23.4 (SHOULD) Server returns valid results for Practitioner search by name
<details>
...
#### 4.23.5 (SHOULD) Server returns valid results for Practitioner search by identifier (HPI-I)
<details>
...
#### 4.23.6 Practitioner resources returned during previous tests conform to the AU Core Practitioner
<details>
...
#### 4.23.7 All must support elements are provided in the Practitioner resources returned
<details>
...
#### 4.24.1 (SHALL) Server returns correct PractitionerRole resource from PractitionerRole read interaction
<details>
...
#### 4.24.2 (SHOULD) Server returns valid results for PractitionerRole search by _id
<details>
...
#### 4.24.3 (SHALL) Server returns valid results for PractitionerRole search by identifier
<details>
...
#### 4.24.4 (SHALL) Server returns valid results for PractitionerRole search by practitioner
<details>
...
#### 4.24.5 (SHOULD) Server returns valid results for PractitionerRole search by specialty
<details>
...
#### 4.24.6 (SHOULD) Server returns valid results for PractitionerRole search by role
<details>
...
#### 4.24.7 (MAY) Server returns valid results for PractitionerRole search by organization
<details>
...
#### 4.24.8 (MAY) Server returns valid results for PractitionerRole multipleOr search by practitioner
<details>
...
#### 4.24.9 (MAY) Server returns valid results for PractitionerRole multipleAnd search by practitioner
<details>
...
#### 4.24.10 (SHOULD) Server returns valid results for PractitionerRole search by practitioner (chained parameters)
<details>
...
#### 4.24.11 (SHOULD) Server returns valid results for PractitionerRole search by identifier (Medicare)
<details>
...
#### 4.24.12 Server returns Practitioner resources from PractitionerRole search by _id and PractitionerRole:practitioner
<details>
...
#### 4.24.13 Server returns Practitioner resources from PractitionerRole search by identifier and PractitionerRole:practitioner
<details>
...
#### 4.24.14 Server returns Practitioner resources from PractitionerRole search by practitioner and PractitionerRole:practitioner
<details>
...
#### 4.24.15 Server returns Practitioner resources from PractitionerRole search by specialty and PractitionerRole:practitioner
<details>
...
#### 4.24.16 PractitionerRole resources returned during previous tests conform to the AU Core PractitionerRole
<details>
...
#### 4.24.17 All must support elements are provided in the PractitionerRole resources returned
<details>
...
#### 4.24.18 MustSupport references within PractitionerRole resources are valid
<details>
