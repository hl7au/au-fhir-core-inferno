  ...
  module AUCoreV200_PREVIEW
    class AUCoreTestSuite < Inferno::TestSuite
      ...
      fhir_resource_validator do
        igs 'hl7.fhir.au.core#2.0.0-preview'
      ...
      group do
        ...
        id :au_core_v200_preview_fhir_api

        group from: :au_core_v030_ballot_capability_statement

        group from: :au_core_v200_preview_patient

        group from: :au_core_v200_preview_bodyweight

        group from: :au_core_v200_preview_bloodpressure

        group from: :au_core_v200_preview_bodyheight

        group from: :au_core_v200_preview_diagnosticresult_path

        group from: :au_core_v200_preview_bodytemp

        group from: :au_core_v200_preview_heartrate

        group from: :au_core_v200_preview_waistcircum

        group from: :au_core_v200_preview_resprate
        ...
        group from: :au_core_v200_preview_condition

        group from: :au_core_v200_preview_encounter

        group from: :au_core_v200_preview_immunization

        group from: :au_core_v200_preview_medication_request

        group from: :au_core_v200_preview_medication_statement

        group from: :au_core_v200_preview_procedure

        group from: :au_core_v200_preview_related_person

        group from: :au_core_v200_preview_healthcare_service

        group from: :au_core_v200_preview_location

        group from: :au_core_v200_preview_organization

        group from: :au_core_v200_preview_practitioner

        group from: :au_core_v200_preview_practitioner_role
