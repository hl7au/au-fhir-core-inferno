...
read succeeds.
      ...
      id :au_core_v030_ballot_bodyheight
      run_as_group
      ...
      test from: :au_core_v030_ballot_bodyheight_date_search_test
      test from: :au_core_v030_ballot_bodyheight_status_search_test
      test from: :au_core_v030_ballot_bodyheight_patient_search_test
      test from: :au_core_v030_ballot_bodyheight_patient_category_search_test
      ...
      test from: :au_core_v030_ballot_bodyheight_patient_ihi_chain_search_test
      test from: :au_core_v030_ballot_bodyheight_patient_medicare_chain_search_test
      test from: :au_core_v030_ballot_bodyheight_patient_dva_chain_search_test
      ...
      test from: :au_core_v030_ballot_bodyheight_must_support_test
      test from: :au_core_v030_ballot_bodyheight_reference_resolution_test
    end
  end
end
