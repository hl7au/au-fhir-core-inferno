...
module AUCoreTestKit
  module AUCoreV030_BALLOT
    class PatientPatientGenderIdentitySearchTest < Inferno::Test
      include AUCoreTestKit::SearchTest

      title '(MAY) Server returns valid results for Patient search by patient-gender-identity'
      description %(
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/0.3.0-ballot/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v030_ballot_patient_patient_gender_identity_search_test
      optional
