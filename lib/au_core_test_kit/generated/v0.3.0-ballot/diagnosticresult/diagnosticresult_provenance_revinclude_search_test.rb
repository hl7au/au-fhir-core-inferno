...
module AUCoreTestKit
  module AUCoreV030_BALLOT
    class DiagnosticresultProvenanceRevincludeSearchTest < Inferno::Test
      ...
      title '(SHALL) Server returns Provenance resources from Observation search by patient + revInclude:Provenance:target'
      description %(
      ...
      id :au_core_v030_ballot_diagnosticresult_provenance_revinclude_search_test
