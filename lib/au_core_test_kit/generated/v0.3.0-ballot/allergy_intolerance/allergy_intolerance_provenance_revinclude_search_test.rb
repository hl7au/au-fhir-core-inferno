...
module AUCoreTestKit
  module AUCoreV030_BALLOT
    class AllergyIntoleranceProvenanceRevincludeSearchTest < Inferno::Test
      ...
      title '(SHALL) Server returns Provenance resources from AllergyIntolerance search by patient + revInclude:Provenance:target'
      description %(
      ...
      id :au_core_v030_ballot_allergy_intolerance_provenance_revinclude_search_test
