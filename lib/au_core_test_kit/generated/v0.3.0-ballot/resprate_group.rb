...
read succeeds.
      ...
      test from: :au_core_v030_ballot_resprate_date_search_test
      test from: :au_core_v030_ballot_resprate_status_search_test
      test from: :au_core_v030_ballot_resprate_patient_search_test
      test from: :au_core_v030_ballot_resprate_patient_category_search_test
      test from: :au_core_v030_ballot_resprate_patient_category_date_search_test
      test from: :au_core_v030_ballot_resprate_patient_category_status_search_test
      test from: :au_core_v030_ballot_resprate_patient_code_date_search_test
      test from: :au_core_v030_ballot_resprate_code_multiple_or_search_test
      ...
      test from: :au_core_v030_ballot_resprate_must_support_test
      test from: :au_core_v030_ballot_resprate_reference_resolution_test
    end
  end
end
