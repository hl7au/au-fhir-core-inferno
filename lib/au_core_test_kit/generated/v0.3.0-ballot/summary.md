...
#### 3.2.13 (SHALL) Server returns Provenance resources from Patient search by _id + revInclude:Provenance:target
<details>
...
#### 3.2.14 Patient resources returned during previous tests conform to the AU Core Patient
<details>
...
#### 3.2.15 All must support elements are provided in the Patient resources returned
<details>
...
#### 3.3.5 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.3.15 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 3.3.16 Observation resources returned during previous tests conform to the AU Core Body Weight
<details>
...
#### 3.3.17 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.3.18 MustSupport references within Observation resources are valid
<details>
...
#### 3.4.5 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.4.15 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 3.4.16 Observation resources returned during previous tests conform to the AU Core Blood Pressure
<details>
...
#### 3.4.17 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.4.18 MustSupport references within Observation resources are valid
<details>
...
#### 3.5.5 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.5.15 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 3.5.16 Observation resources returned during previous tests conform to the AU Core Body Height
<details>
...
#### 3.5.17 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.5.18 MustSupport references within Observation resources are valid
<details>
...
#### 3.6.5 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.6.15 (SHALL) Server returns Provenance resources from Observation search by patient + category + revInclude:Provenance:target
<details>
...
#### 3.6.16 Observation resources returned during previous tests conform to the AU Core Pathology Result Observation
<details>
...
#### 3.6.17 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.6.18 MustSupport references within Observation resources are valid
<details>
...
#### 3.7.5 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.7.15 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 3.7.16 Observation resources returned during previous tests conform to the AU Core Body Temperature
<details>
...
#### 3.7.17 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.7.18 MustSupport references within Observation resources are valid
<details>
...
#### 3.8.5 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.8.15 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 3.8.16 Observation resources returned during previous tests conform to the AU Core Heart Rate
<details>
...
#### 3.8.17 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.8.18 MustSupport references within Observation resources are valid
<details>
...
#### 3.9.5 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.9.15 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 3.9.16 Observation resources returned during previous tests conform to the AU Core Waist Circumference
<details>
...
#### 3.9.17 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.9.18 MustSupport references within Observation resources are valid
<details>
...
#### 3.10.5 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.10.15 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 3.10.16 Observation resources returned during previous tests conform to the AU Core Respiration Rate
<details>
...
#### 3.10.17 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.10.18 MustSupport references within Observation resources are valid
<details>
...
#### 3.11.5 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.11.15 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 3.11.16 Observation resources returned during previous tests conform to the AU Core Diagnostic Result Observation
<details>
...
#### 3.11.17 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.11.18 MustSupport references within Observation resources are valid
<details>
...
#### 3.12.5 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.12.15 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 3.12.16 Observation resources returned during previous tests conform to the AU Core Smoking Status
<details>
...
#### 3.12.17 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.12.18 MustSupport references within Observation resources are valid
<details>
...
#### 3.13.8 (SHALL) Server returns Provenance resources from AllergyIntolerance search by patient + revInclude:Provenance:target
<details>
...
#### 3.14.13 (SHALL) Server returns Provenance resources from Condition search by patient + revInclude:Provenance:target
<details>
...
#### 3.14.14 Condition resources returned during previous tests conform to the AU Core Condition
<details>
...
#### 3.14.15 All must support elements are provided in the Condition resources returned
<details>
...
#### 3.14.16 MustSupport references within Condition resources are valid
<details>
...
#### 3.15.4 (SHOULD) Server returns valid results for Encounter search by patient + discharge-disposition
<details>
...
#### 3.15.5 (SHOULD) Server returns valid results for Encounter search by patient + location
<details>
...
#### 3.15.6 (SHOULD) Server returns valid results for Encounter search by patient + status
<details>
...
#### 3.15.7 (SHOULD) Server returns valid results for Encounter search by patient + type
<details>
...
#### 3.15.8 (MAY) Server returns valid results for Encounter multipleOr search by discharge-disposition
<details>
...
#### 3.15.9 (SHOULD) Server returns valid results for Encounter multipleAnd search by date
<details>
...
#### 3.15.10 (MAY) Server returns valid results for Encounter multipleAnd search by discharge-disposition
<details>
...
#### 3.15.16 (SHALL) Server returns Provenance resources from Encounter search by patient + revInclude:Provenance:target
<details>
...
#### 3.16.10 (SHALL) Server returns Provenance resources from Immunization search by patient + revInclude:Provenance:target
<details>
...
#### 3.16.11 Immunization resources returned during previous tests conform to the AU Core Immunization
<details>
...
#### 3.16.12 All must support elements are provided in the Immunization resources returned
<details>
...
#### 3.16.13 MustSupport references within Immunization resources are valid
<details>
...
#### 3.17.4 (SHALL) Server returns valid results for MedicationRequest search by patient + intent
<details>
...
#### 3.17.5 (SHALL) Server returns valid results for MedicationRequest search by patient + intent + status
<details>
...
#### 3.17.6 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent + authoredon
<details>
...
#### 3.17.7 (SHOULD) Server returns valid results for MedicationRequest multipleOr search by intent
<details>
...
#### 3.17.8 (SHALL) Server returns valid results for MedicationRequest multipleOr search by status
<details>
...
#### 3.17.9 (SHOULD) Server returns valid results for MedicationRequest multipleAnd search by authoredon
<details>
...
#### 3.17.10 (SHOULD) Server returns valid results for MedicationRequest search by patient (chained parameters)
<details>
...
#### 3.17.11 (SHOULD) Server returns valid results for MedicationRequest search by patient (IHI) (chained parameters)
<details>
...
#### 3.17.12 (SHOULD) Server returns valid results for MedicationRequest search by patient (Medicare) (chained parameters)
<details>
...
#### 3.17.13 (SHOULD) Server returns valid results for MedicationRequest search by patient (DVA) (chained parameters)
<details>
...
#### 3.17.14 (SHALL) Server returns correct MedicationRequest resource from MedicationRequest read interaction
<details>
...
#### 3.17.15 (SHALL) Server returns Provenance resources from MedicationRequest search by patient + revInclude:Provenance:target
<details>
...
#### 3.17.16 MedicationRequest resources returned during previous tests conform to the AU Core MedicationRequest
<details>
...
#### 3.17.17 Medication resources returned during previous tests conform to the AU Core Medication
<details>
...
#### 3.17.18 All must support elements are provided in the MedicationRequest resources returned
<details>
...
#### 3.17.19 MustSupport references within MedicationRequest resources are valid
<details>
...
#### 3.18.2 (SHALL) Server returns valid results for MedicationStatement search by patient + status
<details>
...
#### 3.18.3 (SHOULD) Server returns valid results for MedicationStatement search by patient + effective
<details>
...
#### 3.18.4 (SHOULD) Server returns valid results for MedicationStatement search by patient (chained parameters)
<details>
...
#### 3.18.5 (SHOULD) Server returns valid results for MedicationStatement search by patient (IHI) (chained parameters)
<details>
...
#### 3.18.6 (SHOULD) Server returns valid results for MedicationStatement search by patient (Medicare) (chained parameters)
<details>
...
#### 3.18.7 (SHOULD) Server returns valid results for MedicationStatement search by patient (DVA) (chained parameters)
<details>
...
#### 3.18.8 (SHALL) Server returns correct MedicationStatement resource from MedicationStatement read interaction
<details>
...
#### 3.18.9 (SHALL) Server returns Provenance resources from MedicationStatement search by patient + revInclude:Provenance:target
<details>
...
#### 3.18.10 MedicationStatement resources returned during previous tests conform to the AU Core MedicationStatement
<details>
...
#### 3.18.11 All must support elements are provided in the MedicationStatement resources returned
<details>
...
#### 3.18.12 MustSupport references within MedicationStatement resources are valid
<details>
...
#### 3.19.2 (SHALL) Server returns valid results for Procedure search by patient + date
<details>
...
#### 3.19.3 (SHOULD) Server returns valid results for Procedure search by patient + code + date
<details>
...
#### 3.19.4 (SHOULD) Server returns valid results for Procedure search by patient + status
<details>
...
#### 3.19.5 (SHOULD) Server returns valid results for Procedure multipleOr search by code
<details>
...
#### 3.19.6 (SHOULD) Server returns valid results for Procedure multipleOr search by status
<details>
...
#### 3.19.7 (SHOULD) Server returns valid results for Procedure search by patient (chained parameters)
<details>
...
#### 3.19.8 (SHOULD) Server returns valid results for Procedure search by patient (IHI) (chained parameters)
<details>
...
#### 3.19.9 (SHOULD) Server returns valid results for Procedure search by patient (Medicare) (chained parameters)
<details>
...
#### 3.19.10 (SHOULD) Server returns valid results for Procedure search by patient (DVA) (chained parameters)
<details>
...
#### 3.19.11 (SHALL) Server returns correct Procedure resource from Procedure read interaction
<details>
...
#### 3.19.12 (SHALL) Server returns Provenance resources from Procedure search by patient + revInclude:Provenance:target
<details>
...
#### 3.19.13 Procedure resources returned during previous tests conform to the AU Core Procedure
<details>
...
#### 3.19.14 All must support elements are provided in the Procedure resources returned
<details>
...
#### 3.19.15 MustSupport references within Procedure resources are valid
<details>
...
#### 3.20.7 (SHALL) Server returns Provenance resources from Location search by address + revInclude:Provenance:target
<details>
...
#### 3.20.8 Location resources returned during previous tests conform to the AU Core Location
<details>
...
#### 3.20.9 All must support elements are provided in the Location resources returned
<details>
...
#### 3.20.10 MustSupport references within Location resources are valid
<details>
...
#### 3.23.6 (MAY) Server returns valid results for PractitionerRole multipleOr search by practitioner
<details>
...
#### 3.23.7 (MAY) Server returns valid results for PractitionerRole multipleAnd search by practitioner
<details>
...
#### 3.23.8 (SHOULD) Server returns valid results for PractitionerRole search by practitioner (chained parameters)
<details>
...
#### 3.23.9 (SHOULD) Server returns valid results for PractitionerRole search by identifier (Medicare)
<details>
