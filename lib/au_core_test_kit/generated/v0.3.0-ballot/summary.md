...
#### 2.11.6 (SHALL) Server returns valid results for Observation search by patient
<details>
...
#### 2.11.19 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
