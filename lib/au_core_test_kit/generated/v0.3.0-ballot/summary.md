...
#### 1.2.3 (SHOULD) Server returns valid results for Patient search by family
<details>
...
#### 1.2.8 (MAY) Server returns valid results for Patient search by patient-gender-identity
<details>
...
#### 1.2.14 (MAY) Server returns valid results for Patient multipleOr search by patient-gender-identity
<details>
...
#### 1.2.16 (MAY) Server returns valid results for Patient multipleAnd search by patient-gender-identity
<details>
...
#### 1.2.21 (SHALL) Server returns Provenance resources from Patient search by _id + revInclude:Provenance:target
<details>
...
#### 1.2.22 Patient resources returned during previous tests conform to the AU Core Patient
<details>
...
#### 1.2.23 All must support elements are provided in the Patient resources returned
<details>
...
#### 1.3.9 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.3.19 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 1.3.20 Observation resources returned during previous tests conform to the AU Core Body Weight
<details>
...
#### 1.3.21 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.3.22 MustSupport references within Observation resources are valid
<details>
...
#### 1.4.9 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.4.19 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 1.4.20 Observation resources returned during previous tests conform to the AU Core Blood Pressure
<details>
...
#### 1.4.21 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.4.22 MustSupport references within Observation resources are valid
<details>
...
#### 1.5.9 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.5.19 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 1.5.20 Observation resources returned during previous tests conform to the AU Core Body Height
<details>
...
#### 1.5.21 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.5.22 MustSupport references within Observation resources are valid
<details>
...
#### 1.6.9 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.6.19 (SHALL) Server returns Provenance resources from Observation search by patient + category + revInclude:Provenance:target
<details>
...
#### 1.6.20 Observation resources returned during previous tests conform to the AU Core Pathology Result Observation
<details>
...
#### 1.6.21 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.6.22 MustSupport references within Observation resources are valid
<details>
...
#### 1.7.9 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.7.19 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 1.7.20 Observation resources returned during previous tests conform to the AU Core Body Temperature
<details>
...
#### 1.7.21 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.7.22 MustSupport references within Observation resources are valid
<details>
...
#### 1.8.9 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.8.19 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 1.8.20 Observation resources returned during previous tests conform to the AU Core Heart Rate
<details>
...
#### 1.8.21 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.8.22 MustSupport references within Observation resources are valid
<details>
...
#### 1.9.9 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.9.10 (SHOULD) Server returns valid results for Observation search by patient + code + date
<details>
...
#### 1.9.11 (SHOULD) Server returns valid results for Observation multipleOr search by code
<details>
...
#### 1.9.13 (SHOULD) Server returns valid results for Observation multipleAnd search by date
<details>
...
#### 1.9.14 (SHOULD) Server returns valid results for Observation search by patient (chained parameters)
<details>
...
#### 1.9.15 (SHOULD) Server returns valid results for Observation search by patient (IHI) (chained parameters)
<details>
...
#### 1.9.16 (SHOULD) Server returns valid results for Observation search by patient (Medicare) (chained parameters)
<details>
...
#### 1.9.17 (SHOULD) Server returns valid results for Observation search by patient (DVA) (chained parameters)
<details>
...
#### 1.9.18 (SHALL) Server returns correct Observation resource from Observation read interaction
<details>
...
#### 1.9.19 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 1.9.20 Observation resources returned during previous tests conform to the AU Core Waist Circumference
<details>
...
#### 1.9.21 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.9.22 MustSupport references within Observation resources are valid
<details>
...
#### 1.10.2 (MAY) Server returns valid results for Observation search by category
<details>
...
#### 1.10.3 (MAY) Server returns valid results for Observation search by code
<details>
...
#### 1.10.4 (MAY) Server returns valid results for Observation search by date
<details>
...
#### 1.10.5 (MAY) Server returns valid results for Observation search by status
<details>
...
#### 1.10.6 (SHALL) Server returns valid results for Observation search by patient
<details>
...
#### 1.10.7 (SHALL) Server returns valid results for Observation search by patient + category
<details>
...
#### 1.10.8 (SHALL) Server returns valid results for Observation search by patient + category + date
<details>
...
#### 1.10.9 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.10.10 (SHOULD) Server returns valid results for Observation search by patient + code + date
<details>
...
#### 1.10.11 (SHOULD) Server returns valid results for Observation multipleOr search by code
<details>
...
#### 1.10.13 (SHOULD) Server returns valid results for Observation multipleAnd search by date
<details>
...
#### 1.10.14 (SHOULD) Server returns valid results for Observation search by patient (chained parameters)
<details>
...
#### 1.10.15 (SHOULD) Server returns valid results for Observation search by patient (IHI) (chained parameters)
<details>
...
#### 1.10.16 (SHOULD) Server returns valid results for Observation search by patient (Medicare) (chained parameters)
<details>
...
#### 1.10.17 (SHOULD) Server returns valid results for Observation search by patient (DVA) (chained parameters)
<details>
...
#### 1.10.18 (SHALL) Server returns correct Observation resource from Observation read interaction
<details>
...
#### 1.10.19 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 1.10.20 Observation resources returned during previous tests conform to the AU Core Respiration Rate
<details>
...
#### 1.10.21 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.10.22 MustSupport references within Observation resources are valid
<details>
...
#### 1.11.2 (MAY) Server returns valid results for Observation search by category
<details>
...
#### 1.11.3 (MAY) Server returns valid results for Observation search by code
<details>
...
#### 1.11.4 (MAY) Server returns valid results for Observation search by date
<details>
...
#### 1.11.5 (MAY) Server returns valid results for Observation search by status
<details>
...
#### 1.11.9 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.11.10 (SHOULD) Server returns valid results for Observation search by patient + code + date
<details>
...
#### 1.11.11 (SHOULD) Server returns valid results for Observation multipleOr search by code
<details>
...
#### 1.11.13 (SHOULD) Server returns valid results for Observation multipleAnd search by date
<details>
...
#### 1.11.14 (SHOULD) Server returns valid results for Observation search by patient (chained parameters)
<details>
...
#### 1.11.15 (SHOULD) Server returns valid results for Observation search by patient (IHI) (chained parameters)
<details>
...
#### 1.11.16 (SHOULD) Server returns valid results for Observation search by patient (Medicare) (chained parameters)
<details>
...
#### 1.11.17 (SHOULD) Server returns valid results for Observation search by patient (DVA) (chained parameters)
<details>
...
#### 1.11.18 (SHALL) Server returns correct Observation resource from Observation read interaction
<details>
...
#### 1.11.19 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 1.11.20 Observation resources returned during previous tests conform to the AU Core Diagnostic Result Observation
<details>
...
#### 1.11.21 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.11.22 MustSupport references within Observation resources are valid
<details>
...
#### 1.12.2 (MAY) Server returns valid results for Observation search by category
<details>
...
#### 1.12.3 (MAY) Server returns valid results for Observation search by code
<details>
...
#### 1.12.4 (MAY) Server returns valid results for Observation search by date
<details>
...
#### 1.12.5 (MAY) Server returns valid results for Observation search by status
<details>
...
#### 1.12.6 (SHALL) Server returns valid results for Observation search by patient
<details>
...
#### 1.12.7 (SHALL) Server returns valid results for Observation search by patient + category
<details>
...
#### 1.12.8 (SHALL) Server returns valid results for Observation search by patient + category + date
<details>
...
#### 1.12.9 (SHALL) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.12.10 (SHOULD) Server returns valid results for Observation search by patient + code + date
<details>
...
#### 1.12.11 (SHOULD) Server returns valid results for Observation multipleOr search by code
<details>
...
#### 1.12.13 (SHOULD) Server returns valid results for Observation multipleAnd search by date
<details>
...
#### 1.12.14 (SHOULD) Server returns valid results for Observation search by patient (chained parameters)
<details>
...
#### 1.12.15 (SHOULD) Server returns valid results for Observation search by patient (IHI) (chained parameters)
<details>
...
#### 1.12.16 (SHOULD) Server returns valid results for Observation search by patient (Medicare) (chained parameters)
<details>
...
#### 1.12.17 (SHOULD) Server returns valid results for Observation search by patient (DVA) (chained parameters)
<details>
...
#### 1.12.18 (SHALL) Server returns correct Observation resource from Observation read interaction
<details>
...
#### 1.12.19 (SHALL) Server returns Provenance resources from Observation search by patient + code + revInclude:Provenance:target
<details>
...
#### 1.12.20 Observation resources returned during previous tests conform to the AU Core Smoking Status
<details>
...
#### 1.12.21 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.12.22 MustSupport references within Observation resources are valid
<details>
...
#### 1.13.2 (MAY) Server returns valid results for AllergyIntolerance search by clinical-status
<details>
...
#### 1.13.3 (SHOULD) Server returns valid results for AllergyIntolerance search by patient + clinical-status
<details>
...
#### 1.13.4 (SHOULD) Server returns valid results for AllergyIntolerance search by patient (chained parameters)
<details>
...
#### 1.13.5 (SHOULD) Server returns valid results for AllergyIntolerance search by patient (IHI) (chained parameters)
<details>
...
#### 1.13.6 (SHOULD) Server returns valid results for AllergyIntolerance search by patient (Medicare) (chained parameters)
<details>
...
#### 1.13.7 (SHOULD) Server returns valid results for AllergyIntolerance search by patient (DVA) (chained parameters)
<details>
...
#### 1.13.8 (SHALL) Server returns correct AllergyIntolerance resource from AllergyIntolerance read interaction
<details>
...
#### 1.13.9 (SHALL) Server returns Provenance resources from AllergyIntolerance search by patient + revInclude:Provenance:target
<details>
...
#### 1.13.10 AllergyIntolerance resources returned during previous tests conform to the AU Core AllergyIntolerance
<details>
...
#### 1.13.11 All must support elements are provided in the AllergyIntolerance resources returned
<details>
...
#### 1.13.12 MustSupport references within AllergyIntolerance resources are valid
<details>
...
#### 1.14.2 (MAY) Server returns valid results for Condition search by category
<details>
...
#### 1.14.3 (MAY) Server returns valid results for Condition search by clinical-status
<details>
...
#### 1.14.4 (MAY) Server returns valid results for Condition search by code
<details>
...
#### 1.14.5 (MAY) Server returns valid results for Condition search by onset-date
<details>
...
#### 1.14.6 (SHALL) Server returns valid results for Condition search by patient + category
<details>
...
#### 1.14.7 (SHALL) Server returns valid results for Condition search by patient + clinical-status
<details>
...
#### 1.14.8 (SHOULD) Server returns valid results for Condition search by patient + category + clinical-status
<details>
...
#### 1.14.9 (SHOULD) Server returns valid results for Condition search by patient + code
<details>
...
#### 1.14.10 (SHOULD) Server returns valid results for Condition search by patient + onset-date
<details>
...
#### 1.14.11 (SHOULD) Server returns valid results for Condition multipleAnd search by onset-date
<details>
...
#### 1.14.12 (SHOULD) Server returns valid results for Condition search by patient (chained parameters)
<details>
...
#### 1.14.13 (SHOULD) Server returns valid results for Condition search by patient (IHI) (chained parameters)
<details>
...
#### 1.14.14 (SHOULD) Server returns valid results for Condition search by patient (Medicare) (chained parameters)
<details>
...
#### 1.14.15 (SHOULD) Server returns valid results for Condition search by patient (DVA) (chained parameters)
<details>
...
#### 1.14.16 (SHALL) Server returns correct Condition resource from Condition read interaction
<details>
...
#### 1.14.17 (SHALL) Server returns Provenance resources from Condition search by patient + revInclude:Provenance:target
<details>
...
#### 1.14.18 Condition resources returned during previous tests conform to the AU Core Condition
<details>
...
#### 1.14.19 All must support elements are provided in the Condition resources returned
<details>
...
#### 1.14.20 MustSupport references within Condition resources are valid
<details>
...
#### 1.15.2 (MAY) Server returns valid results for Encounter search by class
<details>
...
#### 1.15.3 (MAY) Server returns valid results for Encounter search by date
<details>
...
#### 1.15.4 (MAY) Server returns valid results for Encounter search by discharge-disposition
<details>
...
#### 1.15.5 (MAY) Server returns valid results for Encounter search by identifier
<details>
...
#### 1.15.6 (MAY) Server returns valid results for Encounter search by location
<details>
...
#### 1.15.7 (MAY) Server returns valid results for Encounter search by status
<details>
...
#### 1.15.8 (MAY) Server returns valid results for Encounter search by type
<details>
...
#### 1.15.9 (SHALL) Server returns valid results for Encounter search by date + patient
<details>
...
#### 1.15.10 (SHOULD) Server returns valid results for Encounter search by class + patient
<details>
...
#### 1.15.11 (SHOULD) Server returns valid results for Encounter search by patient + discharge-disposition
<details>
...
#### 1.15.12 (SHOULD) Server returns valid results for Encounter search by patient + location
<details>
...
#### 1.15.13 (SHOULD) Server returns valid results for Encounter search by patient + status
<details>
...
#### 1.15.14 (SHOULD) Server returns valid results for Encounter search by patient + type
<details>
...
#### 1.15.15 (MAY) Server returns valid results for Encounter multipleOr search by discharge-disposition
<details>
...
#### 1.15.16 (SHOULD) Server returns valid results for Encounter multipleAnd search by date
<details>
...
#### 1.15.17 (MAY) Server returns valid results for Encounter multipleAnd search by discharge-disposition
<details>
...
#### 1.15.18 (SHOULD) Server returns valid results for Encounter search by patient (chained parameters)
<details>
...
#### 1.15.19 (SHOULD) Server returns valid results for Encounter search by patient (IHI) (chained parameters)
<details>
...
#### 1.15.20 (SHOULD) Server returns valid results for Encounter search by patient (Medicare) (chained parameters)
<details>
...
#### 1.15.21 (SHOULD) Server returns valid results for Encounter search by patient (DVA) (chained parameters)
<details>
...
#### 1.15.22 (SHALL) Server returns correct Encounter resource from Encounter read interaction
<details>
...
#### 1.15.23 (SHALL) Server returns Provenance resources from Encounter search by patient + revInclude:Provenance:target
<details>
...
#### 1.15.24 Encounter resources returned during previous tests conform to the AU Core Encounter
<details>
...
#### 1.15.25 All must support elements are provided in the Encounter resources returned
<details>
...
#### 1.15.26 MustSupport references within Encounter resources are valid
<details>
...
#### 1.16.2 (MAY) Server returns valid results for Immunization search by date
<details>
...
#### 1.16.3 (MAY) Server returns valid results for Immunization search by status
<details>
...
#### 1.16.4 (MAY) Server returns valid results for Immunization search by vaccine-code
<details>
...
#### 1.16.5 (SHALL) Server returns valid results for Immunization search by patient + status
<details>
...
#### 1.16.6 (SHOULD) Server returns valid results for Immunization search by patient + date
<details>
...
#### 1.16.7 (MAY) Server returns valid results for Immunization search by patient + vaccine-code
<details>
...
#### 1.16.8 (SHOULD) Server returns valid results for Immunization multipleOr search by vaccine-code
<details>
...
#### 1.16.9 (SHOULD) Server returns valid results for Immunization multipleAnd search by date
<details>
...
#### 1.16.10 (SHOULD) Server returns valid results for Immunization search by patient (chained parameters)
<details>
...
#### 1.16.11 (SHOULD) Server returns valid results for Immunization search by patient (IHI) (chained parameters)
<details>
...
#### 1.16.12 (SHOULD) Server returns valid results for Immunization search by patient (Medicare) (chained parameters)
<details>
...
#### 1.16.13 (SHOULD) Server returns valid results for Immunization search by patient (DVA) (chained parameters)
<details>
...
#### 1.16.14 (SHALL) Server returns correct Immunization resource from Immunization read interaction
<details>
...
#### 1.16.15 (SHALL) Server returns Provenance resources from Immunization search by patient + revInclude:Provenance:target
<details>
...
#### 1.16.16 Immunization resources returned during previous tests conform to the AU Core Immunization
<details>
...
#### 1.16.17 All must support elements are provided in the Immunization resources returned
<details>
...
#### 1.16.18 MustSupport references within Immunization resources are valid
<details>
...
#### 1.17.3 (SHALL) Server returns valid results for MedicationRequest search by identifier
<details>
...
#### 1.17.4 (MAY) Server returns valid results for MedicationRequest search by category
<details>
...
#### 1.17.5 (MAY) Server returns valid results for MedicationRequest search by authoredon
<details>
...
#### 1.17.6 (MAY) Server returns valid results for MedicationRequest search by intent
<details>
...
#### 1.17.7 (MAY) Server returns valid results for MedicationRequest search by status
<details>
...
#### 1.17.8 (SHALL) Server returns valid results for MedicationRequest search by patient + intent
<details>
...
#### 1.17.9 (SHALL) Server returns valid results for MedicationRequest search by patient + intent + status
<details>
...
#### 1.17.10 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent + authoredon
<details>
...
#### 1.17.11 (SHOULD) Server returns valid results for MedicationRequest multipleOr search by intent
<details>
...
#### 1.17.12 (SHALL) Server returns valid results for MedicationRequest multipleOr search by status
<details>
...
#### 1.17.13 (SHOULD) Server returns valid results for MedicationRequest multipleAnd search by authoredon
<details>
...
#### 1.17.14 (SHOULD) Server returns valid results for MedicationRequest search by patient (chained parameters)
<details>
...
#### 1.17.15 (SHOULD) Server returns valid results for MedicationRequest search by patient (IHI) (chained parameters)
<details>
...
#### 1.17.16 (SHOULD) Server returns valid results for MedicationRequest search by patient (Medicare) (chained parameters)
<details>
...
#### 1.17.17 (SHOULD) Server returns valid results for MedicationRequest search by patient (DVA) (chained parameters)
<details>
...
#### 1.17.18 (SHALL) Server returns correct MedicationRequest resource from MedicationRequest read interaction
<details>
...
#### 1.17.19 (SHALL) Server returns Provenance resources from MedicationRequest search by patient + revInclude:Provenance:target
<details>
...
#### 1.17.20 MedicationRequest resources returned during previous tests conform to the AU Core MedicationRequest
<details>
...
#### 1.17.21 Medication resources returned during previous tests conform to the AU Core Medication
<details>
...
#### 1.17.22 All must support elements are provided in the MedicationRequest resources returned
<details>
...
#### 1.17.23 MustSupport references within MedicationRequest resources are valid
<details>
...
#### 1.18.1 (SHALL) Server returns valid results for MedicationStatement search by patient
<details>
...
#### 1.18.2 (MAY) Server returns valid results for MedicationStatement search by effective
<details>
...
#### 1.18.3 (MAY) Server returns valid results for MedicationStatement search by status
<details>
...
#### 1.18.4 (SHALL) Server returns valid results for MedicationStatement search by patient + status
<details>
...
#### 1.18.5 (SHOULD) Server returns valid results for MedicationStatement search by patient + effective
<details>
...
#### 1.18.6 (SHOULD) Server returns valid results for MedicationStatement search by patient (chained parameters)
<details>
...
#### 1.18.7 (SHOULD) Server returns valid results for MedicationStatement search by patient (IHI) (chained parameters)
<details>
...
#### 1.18.8 (SHOULD) Server returns valid results for MedicationStatement search by patient (Medicare) (chained parameters)
<details>
...
#### 1.18.9 (SHOULD) Server returns valid results for MedicationStatement search by patient (DVA) (chained parameters)
<details>
...
#### 1.18.10 (SHALL) Server returns correct MedicationStatement resource from MedicationStatement read interaction
<details>
...
#### 1.18.11 (SHALL) Server returns Provenance resources from MedicationStatement search by patient + revInclude:Provenance:target
<details>
...
#### 1.18.12 MedicationStatement resources returned during previous tests conform to the AU Core MedicationStatement
<details>
...
#### 1.18.13 All must support elements are provided in the MedicationStatement resources returned
<details>
...
#### 1.18.14 MustSupport references within MedicationStatement resources are valid
<details>
...
#### 1.19.1 (SHALL) Server returns valid results for Procedure search by patient
<details>
...
#### 1.19.2 (MAY) Server returns valid results for Procedure search by code
<details>
...
#### 1.19.3 (MAY) Server returns valid results for Procedure search by date
<details>
...
#### 1.19.4 (MAY) Server returns valid results for Procedure search by status
<details>
...
#### 1.19.5 (SHALL) Server returns valid results for Procedure search by patient + date
<details>
...
#### 1.19.6 (SHOULD) Server returns valid results for Procedure search by patient + code + date
<details>
...
#### 1.19.7 (SHOULD) Server returns valid results for Procedure search by patient + status
<details>
...
#### 1.19.8 (SHOULD) Server returns valid results for Procedure multipleOr search by code
<details>
...
#### 1.19.9 (SHOULD) Server returns valid results for Procedure multipleOr search by status
<details>
...
#### 1.19.10 (SHOULD) Server returns valid results for Procedure search by patient (chained parameters)
<details>
...
#### 1.19.11 (SHOULD) Server returns valid results for Procedure search by patient (IHI) (chained parameters)
<details>
...
#### 1.19.12 (SHOULD) Server returns valid results for Procedure search by patient (Medicare) (chained parameters)
<details>
...
#### 1.19.13 (SHOULD) Server returns valid results for Procedure search by patient (DVA) (chained parameters)
<details>
...
#### 1.19.14 (SHALL) Server returns correct Procedure resource from Procedure read interaction
<details>
...
#### 1.19.15 (SHALL) Server returns Provenance resources from Procedure search by patient + revInclude:Provenance:target
<details>
...
#### 1.19.16 Procedure resources returned during previous tests conform to the AU Core Procedure
<details>
...
#### 1.19.17 All must support elements are provided in the Procedure resources returned
<details>
...
#### 1.19.18 MustSupport references within Procedure resources are valid
<details>
...
#### 1.20.1 (SHALL) Server returns correct Location resource from Location read interaction
<details>
...
#### 1.20.2 (SHALL) Server returns valid results for Location search by address
<details>
...
#### 1.20.3 (SHALL) Server returns valid results for Location search by name
<details>
...
#### 1.20.4 (SHOULD) Server returns valid results for Location search by address-city
<details>
...
#### 1.20.5 (SHOULD) Server returns valid results for Location search by address-state
<details>
...
#### 1.20.6 (SHOULD) Server returns valid results for Location search by address-postalcode
<details>
...
#### 1.20.7 (MAY) Server returns valid results for Location search by identifier
<details>
...
#### 1.20.8 (SHALL) Server returns Provenance resources from Location search by address + revInclude:Provenance:target
<details>
...
#### 1.20.9 Location resources returned during previous tests conform to the AU Core Location
<details>
...
#### 1.20.10 All must support elements are provided in the Location resources returned
<details>
...
#### 1.20.11 MustSupport references within Location resources are valid
<details>
...
#### 1.21.1 (SHALL) Server returns correct Organization resource from Organization read interaction
<details>
...
#### 1.21.2 (SHOULD) Server returns valid results for Organization search by _id
<details>
...
#### 1.21.3 (SHALL) Server returns valid results for Organization search by address
<details>
...
#### 1.21.4 (SHALL) Server returns valid results for Organization search by identifier
<details>
...
#### 1.21.5 (SHALL) Server returns valid results for Organization search by name
<details>
...
#### 1.21.6 (SHOULD) Server returns valid results for Organization search by identifier (HPI-O)
<details>
...
#### 1.21.7 (SHOULD) Server returns valid results for Organization search by identifier (ABN)
<details>
...
#### 1.21.8 (SHALL) Server returns Provenance resources from Organization search by _id + revInclude:Provenance:target
<details>
...
#### 1.21.9 Organization resources returned during previous tests conform to the AU Core Organization
<details>
...
#### 1.21.10 All must support elements are provided in the Organization resources returned
<details>
...
#### 1.22.1 (SHALL) Server returns correct Practitioner resource from Practitioner read interaction
<details>
...
#### 1.22.2 (SHALL) Server returns valid results for Practitioner search by _id
<details>
...
#### 1.22.3 (SHALL) Server returns valid results for Practitioner search by identifier
<details>
...
#### 1.22.4 (SHOULD) Server returns valid results for Practitioner search by name
<details>
...
#### 1.22.5 (SHOULD) Server returns valid results for Practitioner search by identifier (HPI-I)
<details>
...
#### 1.22.6 Practitioner resources returned during previous tests conform to the AU Core Practitioner
<details>
...
#### 1.22.7 All must support elements are provided in the Practitioner resources returned
<details>
...
#### 1.22.8 MustSupport references within Practitioner resources are valid
<details>
...
#### 1.23.1 (SHALL) Server returns correct PractitionerRole resource from PractitionerRole read interaction
<details>
...
#### 1.23.2 (SHALL) Server returns valid results for PractitionerRole search by _id
<details>
...
#### 1.23.3 (SHALL) Server returns valid results for PractitionerRole search by identifier
<details>
...
#### 1.23.4 (SHALL) Server returns valid results for PractitionerRole search by practitioner
<details>
...
#### 1.23.5 (SHOULD) Server returns valid results for PractitionerRole search by specialty
<details>
...
#### 1.23.6 (MAY) Server returns valid results for PractitionerRole search by organization
<details>
...
#### 1.23.7 (MAY) Server returns valid results for PractitionerRole multipleOr search by practitioner
<details>
...
#### 1.23.8 (MAY) Server returns valid results for PractitionerRole multipleAnd search by practitioner
<details>
...
#### 1.23.9 (SHOULD) Server returns valid results for PractitionerRole search by practitioner (chained parameters)
<details>
...
#### 1.23.10 (SHOULD) Server returns valid results for PractitionerRole search by identifier (Medicare)
<details>
...
#### 1.23.11 (SHALL) Server returns Provenance resources from PractitionerRole search by _id + revInclude:Provenance:target
<details>
...
#### 1.23.12 PractitionerRole resources returned during previous tests conform to the AU Core PractitionerRole
<details>
...
#### 1.23.13 All must support elements are provided in the PractitionerRole resources returned
<details>
...
#### 1.23.14 MustSupport references within PractitionerRole resources are valid
<details>
...
#### 1.24.1 (SHALL) Server returns correct Provenance resource from Provenance read interaction
<details>
...
#### 1.24.2 Provenance resources returned during previous tests conform to the AU Core Provenance
<details>
...
#### 1.24.3 All must support elements are provided in the Provenance resources returned
<details>
...
#### 1.24.4 MustSupport references within Provenance resources are valid
<details>
