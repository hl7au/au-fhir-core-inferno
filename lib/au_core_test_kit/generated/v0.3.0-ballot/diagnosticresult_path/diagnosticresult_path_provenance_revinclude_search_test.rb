...
module AUCoreTestKit
  module AUCoreV030_BALLOT
    class DiagnosticresultPathProvenanceRevincludeSearchTest < Inferno::Test
      include AUCoreTestKit::SearchTest

      title '(SHALL) Server returns Provenance resources from Observation search by patient + category + revInclude:Provenance:target'
      description %(
      ...
      id :au_core_v030_ballot_diagnosticresult_path_provenance_revinclude_search_test
