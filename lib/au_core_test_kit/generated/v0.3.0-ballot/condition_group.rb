...
read succeeds.
      ...
      test from: :au_core_v030_ballot_condition_code_search_test
      test from: :au_core_v030_ballot_condition_onset_date_search_test
      test from: :au_core_v030_ballot_condition_patient_category_search_test
      test from: :au_core_v030_ballot_condition_patient_clinical_status_search_test
      ...
      test from: :au_core_v030_ballot_condition_patient_ihi_chain_search_test
      test from: :au_core_v030_ballot_condition_patient_medicare_chain_search_test
      test from: :au_core_v030_ballot_condition_patient_dva_chain_search_test
      ...
      test from: :au_core_v030_ballot_condition_must_support_test
      test from: :au_core_v030_ballot_condition_reference_resolution_test
    end
  end
end
