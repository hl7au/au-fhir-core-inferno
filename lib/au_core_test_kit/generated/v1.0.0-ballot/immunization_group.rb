...
read succeeds.
      ...
      test from: :au_core_v100_ballot_immunization_patient_medicare_chain_search_test
      test from: :au_core_v100_ballot_immunization_patient_dva_chain_search_test
      test from: :au_core_v100_ballot_immunization_read_test
      test from: :au_core_v100_ballot_immunization_validation_test
      test from: :au_core_v100_ballot_immunization_must_support_test
      test from: :au_core_v100_ballot_immunization_reference_resolution_test
    end
  end
end
