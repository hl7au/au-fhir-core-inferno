...
read succeeds.
      ...
      id :au_core_v100_ballot_procedure
      run_as_group
      ...
      test from: :au_core_v100_ballot_procedure_patient_dva_chain_search_test
      test from: :au_core_v100_ballot_procedure_read_test
      test from: :au_core_v100_ballot_procedure_validation_test
      test from: :au_core_v100_ballot_procedure_must_support_test
      test from: :au_core_v100_ballot_procedure_reference_resolution_test
    end
  end
end
