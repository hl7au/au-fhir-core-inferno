...
read succeeds.
      ...
      test from: :au_core_v200_encounter_class_search_test
      test from: :au_core_v200_encounter_date_search_test
      test from: :au_core_v200_encounter_location_search_test
      test from: :au_core_v200_encounter_status_search_test
      test from: :au_core_v200_encounter_date_patient_search_test
      ...
      test from: :au_core_v200_encounter_reference_resolution_test
    end
  end
end
