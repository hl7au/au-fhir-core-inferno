...
read succeeds.
      ...
      test from: :au_core_v200_procedure_code_search_test
      test from: :au_core_v200_procedure_date_search_test
      test from: :au_core_v200_procedure_status_search_test
      ...
      test from: :au_core_v200_procedure_reference_resolution_test
    end
  end
end
