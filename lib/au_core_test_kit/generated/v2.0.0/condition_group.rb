...
read succeeds.
      ...
      test from: :au_core_v200_condition_category_search_test
      test from: :au_core_v200_condition_clinical_status_search_test
      test from: :au_core_v200_condition_code_search_test
      test from: :au_core_v200_condition_onset_date_search_test
      test from: :au_core_v200_condition_patient_category_search_test
      test from: :au_core_v200_condition_patient_clinical_status_search_test
      ...
      test from: :au_core_v200_condition_reference_resolution_test
    end
  end
end
