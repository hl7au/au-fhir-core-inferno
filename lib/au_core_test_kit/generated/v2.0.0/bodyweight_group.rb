...
read succeeds.
      ...
      test from: :au_core_v200_bodyweight_patient_code_search_test
      test from: :au_core_v200_bodyweight_category_search_test
      test from: :au_core_v200_bodyweight_code_search_test
      test from: :au_core_v200_bodyweight_date_search_test
      test from: :au_core_v200_bodyweight_status_search_test
      test from: :au_core_v200_bodyweight_patient_search_test
      test from: :au_core_v200_bodyweight_patient_category_search_test
      test from: :au_core_v200_bodyweight_patient_category_date_search_test
      test from: :au_core_v200_bodyweight_patient_category_status_search_test
      test from: :au_core_v200_bodyweight_patient_code_date_search_test
      test from: :au_core_v200_bodyweight_code_multiple_or_search_test
      ...
      test from: :au_core_v200_bodyweight_reference_resolution_test
    end
  end
end
