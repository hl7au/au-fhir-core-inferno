...
read succeeds.
      ...
      id :au_core_v200_allergy_intolerance
      run_as_group
      ...
      test from: :au_core_v200_allergy_intolerance_patient_search_test
      ...
      test from: :au_core_v200_allergy_intolerance_reference_resolution_test
    end
  end
end
