...
read succeeds.
      ...
      test from: :au_core_v200_heartrate_category_search_test
      test from: :au_core_v200_heartrate_code_search_test
      test from: :au_core_v200_heartrate_date_search_test
      test from: :au_core_v200_heartrate_status_search_test
      test from: :au_core_v200_heartrate_patient_search_test
      test from: :au_core_v200_heartrate_patient_category_search_test
      test from: :au_core_v200_heartrate_patient_category_date_search_test
      test from: :au_core_v200_heartrate_patient_category_status_search_test
      test from: :au_core_v200_heartrate_patient_code_date_search_test
      test from: :au_core_v200_heartrate_code_multiple_or_search_test
      ...
      test from: :au_core_v200_heartrate_reference_resolution_test
    end
  end
end
