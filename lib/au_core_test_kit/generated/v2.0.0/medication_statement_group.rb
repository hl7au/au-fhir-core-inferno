...
read succeeds.
      ...
      id :au_core_v200_medication_statement
      run_as_group
      ...
      test from: :au_core_v200_medication_statement__id_search_test
      test from: :au_core_v200_medication_statement_effective_search_test
      test from: :au_core_v200_medication_statement_status_search_test
      ...
      test from: :au_core_v200_medication_statement_reference_resolution_test
    end
  end
end
