...
read succeeds.
      ...
      test from: :au_core_v200_bodytemp_category_search_test
      test from: :au_core_v200_bodytemp_code_search_test
      test from: :au_core_v200_bodytemp_date_search_test
      test from: :au_core_v200_bodytemp_status_search_test
      test from: :au_core_v200_bodytemp_patient_search_test
      test from: :au_core_v200_bodytemp_patient_category_search_test
      test from: :au_core_v200_bodytemp_patient_category_date_search_test
      test from: :au_core_v200_bodytemp_patient_category_status_search_test
      test from: :au_core_v200_bodytemp_patient_code_date_search_test
      test from: :au_core_v200_bodytemp_code_multiple_or_search_test
      ...
      test from: :au_core_v200_bodytemp_reference_resolution_test
    end
  end
end
