...
read succeeds.
      ...
      id :au_core_v100_preview_practitioner
      run_as_group
      ...
      test from: :au_core_v100_preview_practitioner_read_test
      test from: :au_core_v100_preview_practitioner__id_search_test
      test from: :au_core_v100_preview_practitioner_identifier_search_test
      test from: :au_core_v100_preview_practitioner_name_search_test
      test from: :au_core_v100_preview_practitioner_identifier_hpii_search_test
      test from: :au_core_v100_preview_practitioner_validation_test
      test from: :au_core_v100_preview_practitioner_must_support_test
    end
  end
end
