  ...
  module AUCoreV100_PREVIEW
    class AUCoreTestSuite < Inferno::TestSuite
      ...
      fhir_resource_validator do
        igs 'hl7.fhir.au.core#1.0.0-preview'
      ...
      group do
        ...
        id :au_core_v100_preview_fhir_api

        group from: :au_core_v030_ballot_capability_statement

        group from: :au_core_v100_preview_patient

        group from: :au_core_v100_preview_bodyweight

        group from: :au_core_v100_preview_bloodpressure

        group from: :au_core_v100_preview_bodyheight

        group from: :au_core_v100_preview_diagnosticresult_path

        group from: :au_core_v100_preview_bodytemp

        group from: :au_core_v100_preview_heartrate

        group from: :au_core_v100_preview_waistcircum

        group from: :au_core_v100_preview_resprate

        group from: :au_core_v100_preview_diagnosticresult

        group from: :au_core_v100_preview_smokingstatus

        group from: :au_core_v100_preview_allergy_intolerance

        group from: :au_core_v100_preview_condition

        group from: :au_core_v100_preview_encounter

        group from: :au_core_v100_preview_immunization

        group from: :au_core_v100_preview_medication_request

        group from: :au_core_v100_preview_procedure

        group from: :au_core_v100_preview_location

        group from: :au_core_v100_preview_organization

        group from: :au_core_v100_preview_practitioner

        group from: :au_core_v100_preview_practitioner_role
