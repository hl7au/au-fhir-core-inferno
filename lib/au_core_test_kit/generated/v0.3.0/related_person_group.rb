...
require_relative 'related_person/related_person_identifier_search_test'
...
module AUCoreTestKit
  module AUCoreV030
    class RelatedPersonGroup < Inferno::TestGroup
      title 'AU Base Related Person Tests'
      short_description 'Verify support for the server capabilities required by the AU Base Related Person.'
      description %(
  # Background
...
read succeeds.
      ...
      id :au_core_v030_related_person
      run_as_group
      ...
      test from: :au_core_v030_related_person_patient_search_test
      test from: :au_core_v030_related_person__id_search_test
