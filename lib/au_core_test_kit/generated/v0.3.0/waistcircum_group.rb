...
read succeeds.
      ...
      test from: :au_core_v030_waistcircum_patient_code_search_test
      test from: :au_core_v030_waistcircum_patient_search_test
      test from: :au_core_v030_waistcircum_patient_category_search_test
      test from: :au_core_v030_waistcircum_patient_category_date_search_test
      test from: :au_core_v030_waistcircum_patient_category_status_search_test
      test from: :au_core_v030_waistcircum_patient_code_date_search_test
      test from: :au_core_v030_waistcircum_read_test
      test from: :au_core_v030_waistcircum_provenance_revinclude_search_test
      test from: :au_core_v030_waistcircum_validation_test
      test from: :au_core_v030_waistcircum_must_support_test
      test from: :au_core_v030_waistcircum_reference_resolution_test
    end
  end
end
