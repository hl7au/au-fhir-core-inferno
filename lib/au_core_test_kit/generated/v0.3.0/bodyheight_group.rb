...
read succeeds.
      ...
      test from: :au_core_v030_bodyheight_patient_code_search_test
      test from: :au_core_v030_bodyheight_patient_search_test
      test from: :au_core_v030_bodyheight_patient_category_search_test
