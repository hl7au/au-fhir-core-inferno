...
module USCoreTestKit
  module USCoreV030
    class AuCoreDiagnosticresultPathProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v030_au_core_diagnosticresult_path_provenance_revinclude_search_test
