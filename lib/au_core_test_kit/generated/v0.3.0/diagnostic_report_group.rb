...
require_relative 'diagnostic_report/diagnostic_report_provenance_revinclude_search_test'
...
read succeeds.
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'diagnostic_report', 'metadata.yml'), aliases: true))
      end
  
      test from: :au_core_v030_diagnostic_report_patient_search_test
      test from: :au_core_v030_diagnostic_report__id_search_test
      test from: :au_core_v030_diagnostic_report_identifier_search_test
      test from: :au_core_v030_diagnostic_report_patient_category_search_test
      test from: :au_core_v030_diagnostic_report_patient_category_date_search_test
      test from: :au_core_v030_diagnostic_report_patient_category_status_search_test
      test from: :au_core_v030_diagnostic_report_patient_code_search_test
      test from: :au_core_v030_diagnostic_report_patient_code_date_search_test
      test from: :au_core_v030_diagnostic_report_patient_status_search_test
      test from: :au_core_v030_diagnostic_report_provenance_revinclude_search_test
      test from: :au_core_v030_diagnostic_report_read_test
      test from: :au_core_v030_diagnostic_report_validation_test
      test from: :au_core_v030_diagnostic_report_must_support_test
      test from: :au_core_v030_diagnostic_report_reference_resolution_test
    end
  end
end
