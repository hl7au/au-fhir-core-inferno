...
read succeeds.
      ...
      test from: :au_core_v030_provenance_read_test
      test from: :au_core_v030_provenance_validation_test
      test from: :au_core_v030_provenance_must_support_test
      test from: :au_core_v030_provenance_reference_resolution_test
    end
  end
end
