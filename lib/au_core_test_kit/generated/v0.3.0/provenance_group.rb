...
The US Core AU Core Provenance sequence verifies that the system under test is
...
read succeeds.
      ...
      test from: :us_core_v030_provenance_read_test
      test from: :us_core_v030_provenance_validation_test
      test from: :us_core_v030_provenance_must_support_test
      test from: :us_core_v030_provenance_reference_resolution_test
    end
  end
end
