...
require_relative 'document_reference/document_reference_identifier_search_test'
...
require_relative 'document_reference/document_reference_patient_category_status_search_test'
require_relative 'document_reference/document_reference_patient_contenttype_search_test'
...
The US Core AU Core DocumentReference sequence verifies that the system under test is
...
read succeeds.
      ...
      id :us_core_v030_document_reference
      run_as_group
      ...
      test from: :us_core_v030_document_reference_patient_search_test
      test from: :us_core_v030_document_reference__id_search_test
      test from: :us_core_v030_document_reference_identifier_search_test
      test from: :us_core_v030_document_reference_patient_category_search_test
      test from: :us_core_v030_document_reference_patient_category_date_search_test
      test from: :us_core_v030_document_reference_patient_category_status_search_test
      test from: :us_core_v030_document_reference_patient_contenttype_search_test
      test from: :us_core_v030_document_reference_patient_status_search_test
      test from: :us_core_v030_document_reference_patient_type_search_test
      test from: :us_core_v030_document_reference_patient_type_date_search_test
      test from: :us_core_v030_document_reference_read_test
      test from: :us_core_v030_document_reference_provenance_revinclude_search_test
      test from: :us_core_v030_document_reference_validation_test
      test from: :us_core_v030_document_reference_must_support_test
      test from: :us_core_v030_document_reference_reference_resolution_test
