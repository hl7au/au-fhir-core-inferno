...
read succeeds.
      ...
      test from: :au_core_v030_document_reference_patient_search_test
      test from: :au_core_v030_document_reference__id_search_test
      test from: :au_core_v030_document_reference_identifier_search_test
      test from: :au_core_v030_document_reference_patient_category_search_test
      test from: :au_core_v030_document_reference_patient_category_date_search_test
      test from: :au_core_v030_document_reference_patient_category_status_search_test
      test from: :au_core_v030_document_reference_patient_contenttype_search_test
      test from: :au_core_v030_document_reference_patient_status_search_test
      test from: :au_core_v030_document_reference_patient_type_search_test
      test from: :au_core_v030_document_reference_patient_type_date_search_test
      test from: :au_core_v030_document_reference_provenance_revinclude_search_test
      test from: :au_core_v030_document_reference_read_test
      test from: :au_core_v030_document_reference_validation_test
      test from: :au_core_v030_document_reference_must_support_test
      test from: :au_core_v030_document_reference_reference_resolution_test
      test from: :au_core_v400_document_reference_custodian_test
    end
  end
end
