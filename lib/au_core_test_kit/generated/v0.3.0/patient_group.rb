...
The US Core AU Core Patient sequence verifies that the system under test is
...
read succeeds.
      ...
      test from: :us_core_v030_patient__id_search_test
      test from: :us_core_v030_patient_family_search_test
      test from: :us_core_v030_patient_identifier_search_test
      test from: :us_core_v030_patient_name_search_test
      test from: :us_core_v030_patient_birthdate_family_search_test
      test from: :us_core_v030_patient_birthdate_name_search_test
      test from: :us_core_v030_patient_family_gender_search_test
      test from: :us_core_v030_patient_gender_name_search_test
      test from: :us_core_v030_patient_read_test
      test from: :us_core_v030_patient_provenance_revinclude_search_test
      test from: :us_core_v030_patient_validation_test
      test from: :us_core_v030_patient_must_support_test
    end
  end
end
