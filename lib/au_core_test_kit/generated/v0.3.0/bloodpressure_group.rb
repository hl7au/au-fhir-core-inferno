...
The AU Core Observation AU Core Blood Pressure sequence verifies that the system under test is
...
read succeeds.
      ...
      test from: :au_core_v030_bloodpressure_patient_code_search_test
      test from: :au_core_v030_bloodpressure_patient_search_test
      test from: :au_core_v030_bloodpressure_patient_category_search_test
