require_relative 'headcircum/headcircum_patient_code_search_test'
require_relative 'headcircum/headcircum_patient_search_test'
require_relative 'headcircum/headcircum_patient_category_search_test'
require_relative 'headcircum/headcircum_patient_category_date_search_test'
require_relative 'headcircum/headcircum_patient_category_status_search_test'
require_relative 'headcircum/headcircum_patient_code_date_search_test'
require_relative 'headcircum/headcircum_read_test'
require_relative 'headcircum/headcircum_provenance_revinclude_search_test'
require_relative 'headcircum/headcircum_validation_test'
require_relative 'headcircum/headcircum_must_support_test'
require_relative 'headcircum/headcircum_reference_resolution_test'
...
read succeeds.
      ...
      id :au_core_v030_headcircum
      run_as_group

      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'headcircum', 'metadata.yml'), aliases: true))
      end
  
      test from: :au_core_v030_headcircum_patient_code_search_test
      test from: :au_core_v030_headcircum_patient_search_test
      test from: :au_core_v030_headcircum_patient_category_search_test
