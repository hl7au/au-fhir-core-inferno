...
The US Core AU Core Practitioner sequence verifies that the system under test is
...
read succeeds.
      ...
      test from: :us_core_v030_practitioner_read_test
      test from: :us_core_v030_practitioner__id_search_test
      test from: :us_core_v030_practitioner_identifier_search_test
      test from: :us_core_v030_practitioner_name_search_test
      test from: :us_core_v030_practitioner_validation_test
      test from: :us_core_v030_practitioner_must_support_test
      test from: :us_core_v030_practitioner_reference_resolution_test
    end
  end
end
