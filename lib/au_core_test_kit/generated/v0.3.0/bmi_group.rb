...
require_relative 'bmi/bmi_patient_search_test'
...
read succeeds.
      ...
      test from: :au_core_v030_bmi_patient_code_search_test
      test from: :au_core_v030_bmi_patient_search_test
      test from: :au_core_v030_bmi_patient_category_search_test
