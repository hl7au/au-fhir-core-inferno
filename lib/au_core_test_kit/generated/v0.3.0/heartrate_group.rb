...
The AU Core Observation AU Core Heart Rate sequence verifies that the system under test is
...
read succeeds.
      ...
      test from: :au_core_v030_heartrate_patient_code_search_test
      test from: :au_core_v030_heartrate_patient_search_test
      test from: :au_core_v030_heartrate_patient_category_search_test
      test from: :au_core_v030_heartrate_patient_category_date_search_test
      test from: :au_core_v030_heartrate_patient_category_status_search_test
      test from: :au_core_v030_heartrate_patient_code_date_search_test
      test from: :au_core_v030_heartrate_read_test
      test from: :au_core_v030_heartrate_provenance_revinclude_search_test
      test from: :au_core_v030_heartrate_validation_test
      test from: :au_core_v030_heartrate_must_support_test
      test from: :au_core_v030_heartrate_reference_resolution_test
    end
  end
end
