...
module AUCoreTestKit
  module AUCoreV210_DRAFT
    class CompositionPatient_Medicare_ChainSearchTest < Inferno::Test
      include InfernoSuiteGenerator::ChainedSearchTest

      title '(SHOULD) Server returns valid results for Composition search by patient (Medicare) (chained parameters)'
      description %(A server SHOULD support searching by
patient:Patient.identifier (Medicare) on the Composition resource. This test
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core/2.1.0-draft/CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v210_draft_composition_patient_medicare_chain_search_test
