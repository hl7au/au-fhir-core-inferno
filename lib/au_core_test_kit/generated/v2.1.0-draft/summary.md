...
requirement of AU Core v2.1.0-draft.
...
## 2.14 Composition Tests

<details>

<summary>Verify support for the server capabilities required by the AU Core Composition.</summary>
...
#### 2.14.1 (SHALL) Server returns valid results for Composition search by patient
<details>

<summary>Show details</summary>

A server SHALL support searching by
patient on the Composition resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /Composition?patient={patient} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Composition?patient={patient}
```
...
#### 2.14.2 (MAY) Server returns valid results for Composition search by type
<details>
...
```bash
GET /Composition?type={type} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Composition?type={type}
```
...
#### 2.14.3 (MAY) Server returns valid results for Composition search by date
<details>

<summary>Show details</summary>

A server MAY support searching by
date on the Composition resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /Composition?date={date} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Composition?date={date}
```
...
#### 2.14.4 (MAY) Server returns valid results for Composition search by author
<details>

<summary>Show details</summary>

A server MAY support searching by
author on the Composition resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /Composition?author={author} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Composition?author={author}
```
...
#### 2.14.5 (SHALL) Server returns valid results for Composition search by patient + type
<details>

<summary>Show details</summary>

A server SHALL support searching by
patient + type on the Composition resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /Composition?patient type={patient type} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Composition?patient type={patient type}
```
...
#### 2.14.6 (SHOULD) Server returns valid results for Composition search by patient + author
<details>

<summary>Show details</summary>

A server SHOULD support searching by
patient + author on the Composition resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /Composition?patient author={patient author} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Composition?patient author={patient author}
```
...
#### 2.14.7 (SHALL) Server returns valid results for Composition search by patient + date
<details>

<summary>Show details</summary>

A server SHALL support searching by
patient + date on the Composition resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /Composition?patient date={patient date} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Composition?patient date={patient date}
```
...
#### 2.14.8 (SHOULD) Server returns valid results for Composition search by patient (chained parameters)
<details>

<summary>Show details</summary>

A server SHOULD support searching by
patient:Patient.identifier on the Composition resource. This test
will pass if the server returns a success response to the request.
...
```bash
GET /Composition?patient:Patient.identifier={patient:Patient.identifier} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Composition?patient:Patient.identifier={patient:Patient.identifier}
```
...
#### 2.14.9 (SHOULD) Server returns valid results for Composition search by patient (IHI) (chained parameters)
<details>
...
#### 2.14.10 (SHOULD) Server returns valid results for Composition search by patient (Medicare) (chained parameters)
<details>
...
#### 2.14.11 (SHOULD) Server returns valid results for Composition search by patient (DVA) (chained parameters)
<details>
...
#### 2.14.12 (SHALL) Server returns correct Composition resource from Composition read interaction
<details>

<summary>Show details</summary>

A server SHALL support the Composition read interaction.
...
#### 2.14.13 Composition resources returned during previous tests conform to the AU Core Composition
<details>

<summary>Show details</summary>

This test verifies resources returned from the first search conform to
the [AU Core Composition](http://hl7.org.au/fhir/core/StructureDefinition/au-core-composition
...
#### 2.14.14 All must support elements are provided in the Composition resources returned
<details>
...
#### 2.14.15 MustSupport references within Composition resources are valid
<details>
...
#### 2.15.1 (SHALL) Server returns valid results for Condition search by patient
<details>
...
#### 2.15.2 (MAY) Server returns valid results for Condition search by category
<details>
...
#### 2.15.3 (MAY) Server returns valid results for Condition search by clinical-status
<details>
...
#### 2.15.4 (MAY) Server returns valid results for Condition search by code
<details>
...
#### 2.15.5 (MAY) Server returns valid results for Condition search by onset-date
<details>
...
#### 2.15.6 (SHALL) Server returns valid results for Condition search by patient + category
<details>
...
#### 2.15.7 (SHALL) Server returns valid results for Condition search by patient + clinical-status
<details>
...
#### 2.15.8 (SHOULD) Server returns valid results for Condition search by patient + category + clinical-status
<details>
...
#### 2.15.9 (SHOULD) Server returns valid results for Condition search by patient + code
<details>
...
#### 2.15.10 (SHOULD) Server returns valid results for Condition search by patient + onset-date
<details>
...
#### 2.15.11 (MAY) Server returns valid results for Condition multipleOr search by code
<details>
...
#### 2.15.12 (SHOULD) Server returns valid results for Condition multipleAnd search by onset-date
<details>
...
#### 2.15.13 (SHOULD) Server returns valid results for Condition search by patient (chained parameters)
<details>
...
#### 2.15.14 (SHOULD) Server returns valid results for Condition search by patient (IHI) (chained parameters)
<details>
...
#### 2.15.15 (SHOULD) Server returns valid results for Condition search by patient (Medicare) (chained parameters)
<details>
...
#### 2.15.16 (SHOULD) Server returns valid results for Condition search by patient (DVA) (chained parameters)
<details>
...
#### 2.15.17 (SHALL) Server returns correct Condition resource from Condition read interaction
<details>
...
#### 2.15.18 Condition resources returned during previous tests conform to the AU Core Condition
<details>
...
#### 2.15.19 All must support elements are provided in the Condition resources returned
<details>
...
#### 2.15.20 MustSupport references within Condition resources are valid
<details>
...
## 2.16 DiagnosticReport Tests

<details>

<summary>Verify support for the server capabilities required by the AU Core DiagnosticReport.</summary>
...
#### 2.16.1 (SHALL) Server returns valid results for DiagnosticReport search by patient
<details>
...
#### 2.16.2 (SHALL) Server returns valid results for DiagnosticReport search by _id
<details>
...
#### 2.16.3 (SHOULD) Server returns valid results for DiagnosticReport search by identifier
<details>
...
#### 2.16.4 (MAY) Server returns valid results for DiagnosticReport search by category
<details>
...
```bash
GET /DiagnosticReport?category={category} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?category={category}
```
...
#### 2.16.5 (MAY) Server returns valid results for DiagnosticReport search by code
<details>
...
```bash
GET /DiagnosticReport?code={code} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?code={code}
```
...
#### 2.16.6 (MAY) Server returns valid results for DiagnosticReport search by date
<details>
...
```bash
GET /DiagnosticReport?date={date} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?date={date}
```
...
#### 2.16.7 (MAY) Server returns valid results for DiagnosticReport search by status
<details>
...
```bash
GET /DiagnosticReport?status={status} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?status={status}
```
...
#### 2.16.8 (SHALL) Server returns valid results for DiagnosticReport search by patient + category
<details>
...
```bash
GET /DiagnosticReport?patient category={patient category} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?patient category={patient category}
```
...
#### 2.16.9 (SHALL) Server returns valid results for DiagnosticReport search by patient + category + date
<details>
...
```bash
GET /DiagnosticReport?patient category date={patient category date} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?patient category date={patient category date}
```
...
#### 2.16.10 (SHOULD) Server returns valid results for DiagnosticReport search by patient + category + status
<details>

<summary>Show details</summary>

A server SHOULD support searching by
patient + category + status on the DiagnosticReport resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /DiagnosticReport?patient category status={patient category status} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?patient category status={patient category status}
```
...
#### 2.16.11 (SHOULD) Server returns valid results for DiagnosticReport search by patient + code
<details>
...
```bash
GET /DiagnosticReport?patient code={patient code} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?patient code={patient code}
```
...
#### 2.16.12 (SHOULD) Server returns valid results for DiagnosticReport search by patient + status
<details>
...
```bash
GET /DiagnosticReport?patient status={patient status} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?patient status={patient status}
```
...
#### 2.16.13 (SHOULD) Server returns valid results for DiagnosticReport search by patient + code + date
<details>
...
```bash
GET /DiagnosticReport?patient code date={patient code date} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?patient code date={patient code date}
```
...
#### 2.16.14 (SHOULD) Server returns valid results for DiagnosticReport search by patient (chained parameters)
<details>

<summary>Show details</summary>

A server SHOULD support searching by
patient:Patient.identifier on the DiagnosticReport resource. This test
will pass if the server returns a success response to the request.
...
```bash
GET /DiagnosticReport?patient:Patient.identifier={patient:Patient.identifier} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DiagnosticReport?patient:Patient.identifier={patient:Patient.identifier}
```
...
#### 2.16.15 (SHOULD) Server returns valid results for DiagnosticReport search by patient (IHI) (chained parameters)
<details>
...
#### 2.16.16 (SHOULD) Server returns valid results for DiagnosticReport search by patient (Medicare) (chained parameters)
<details>
...
#### 2.16.17 (SHOULD) Server returns valid results for DiagnosticReport search by patient (DVA) (chained parameters)
<details>
...
#### 2.16.18 (SHALL) Server returns correct DiagnosticReport resource from DiagnosticReport read interaction
<details>
...
#### 2.16.19 DiagnosticReport resources returned during previous tests conform to the AU Core DiagnosticReport
<details>
...
#### 2.16.20 All must support elements are provided in the DiagnosticReport resources returned
<details>
...
#### 2.16.21 MustSupport references within DiagnosticReport resources are valid
<details>
...
## 2.17 DocumentReference Tests

<details>

<summary>Verify support for the server capabilities required by the AU Core DocumentReference.</summary>
...
#### 2.17.1 (SHALL) Server returns valid results for DocumentReference search by patient
<details>
...
#### 2.17.2 (MAY) Server returns valid results for DocumentReference search by author
<details>

<summary>Show details</summary>

A server MAY support searching by
author on the DocumentReference resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /DocumentReference?author={author} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DocumentReference?author={author}
```
...
#### 2.17.3 (MAY) Server returns valid results for DocumentReference search by type
<details>

<summary>Show details</summary>

A server MAY support searching by
type on the DocumentReference resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /DocumentReference?type={type} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DocumentReference?type={type}
```
...
#### 2.17.4 (MAY) Server returns valid results for DocumentReference search by date
<details>

<summary>Show details</summary>

A server MAY support searching by
date on the DocumentReference resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /DocumentReference?date={date} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DocumentReference?date={date}
```
...
#### 2.17.5 (MAY) Server returns valid results for DocumentReference search by period
<details>

<summary>Show details</summary>

A server MAY support searching by
period on the DocumentReference resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /DocumentReference?period={period} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DocumentReference?period={period}
```
...
#### 2.17.6 (SHALL) Server returns valid results for DocumentReference search by patient + type
<details>
...
```bash
GET /DocumentReference?patient type={patient type} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DocumentReference?patient type={patient type}
```
...
#### 2.17.7 (SHOULD) Server returns valid results for DocumentReference search by patient + type + period
<details>
...
```bash
GET /DocumentReference?patient type period={patient type period} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DocumentReference?patient type period={patient type period}
```
...
#### 2.17.8 (SHOULD) Server returns valid results for DocumentReference search by patient + type + date
<details>
...
```bash
GET /DocumentReference?patient type date={patient type date} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DocumentReference?patient type date={patient type date}
```
...
#### 2.17.9 (SHOULD) Server returns valid results for DocumentReference search by patient + author
<details>

<summary>Show details</summary>

A server SHOULD support searching by
patient + author on the DocumentReference resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /DocumentReference?patient author={patient author} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DocumentReference?patient author={patient author}
```
...
#### 2.17.10 (SHOULD) Server returns valid results for DocumentReference search by patient (chained parameters)
<details>

<summary>Show details</summary>

A server SHOULD support searching by
patient:Patient.identifier on the DocumentReference resource. This test
will pass if the server returns a success response to the request.
...
```bash
GET /DocumentReference?patient:Patient.identifier={patient:Patient.identifier} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/DocumentReference?patient:Patient.identifier={patient:Patient.identifier}
```
...
#### 2.17.11 (SHOULD) Server returns valid results for DocumentReference search by patient (IHI) (chained parameters)
<details>
...
#### 2.17.12 (SHOULD) Server returns valid results for DocumentReference search by patient (Medicare) (chained parameters)
<details>
...
#### 2.17.13 (SHOULD) Server returns valid results for DocumentReference search by patient (DVA) (chained parameters)
<details>
...
#### 2.17.14 (SHALL) Server returns correct DocumentReference resource from DocumentReference read interaction
<details>
...
#### 2.17.15 DocumentReference resources returned during previous tests conform to the AU Core DocumentReference
<details>
...
#### 2.17.16 All must support elements are provided in the DocumentReference resources returned
<details>
...
#### 2.17.17 MustSupport references within DocumentReference resources are valid
<details>
...
#### 2.18.1 (SHALL) Server returns valid results for Encounter search by patient
<details>
...
#### 2.18.2 (MAY) Server returns valid results for Encounter search by class
<details>
...
#### 2.18.3 (MAY) Server returns valid results for Encounter search by date
<details>
...
#### 2.18.4 (MAY) Server returns valid results for Encounter search by location
<details>
...
#### 2.18.5 (MAY) Server returns valid results for Encounter search by status
<details>
...
#### 2.18.6 (SHALL) Server returns valid results for Encounter search by date + patient
<details>
...
#### 2.18.7 (SHOULD) Server returns valid results for Encounter search by class + patient
<details>
...
#### 2.18.8 (SHOULD) Server returns valid results for Encounter search by patient + location
<details>
...
#### 2.18.9 (SHOULD) Server returns valid results for Encounter search by patient + status
<details>
...
#### 2.18.10 (MAY) Server returns valid results for Encounter multipleOr search by status
<details>
...
#### 2.18.11 (SHOULD) Server returns valid results for Encounter multipleAnd search by date
<details>
...
#### 2.18.12 (SHOULD) Server returns valid results for Encounter search by patient (chained parameters)
<details>
...
#### 2.18.13 (SHOULD) Server returns valid results for Encounter search by patient (IHI) (chained parameters)
<details>
...
#### 2.18.14 (SHOULD) Server returns valid results for Encounter search by patient (Medicare) (chained parameters)
<details>
...
#### 2.18.15 (SHOULD) Server returns valid results for Encounter search by patient (DVA) (chained parameters)
<details>
...
#### 2.18.16 (SHALL) Server returns correct Encounter resource from Encounter read interaction
<details>
...
#### 2.18.17 Encounter resources returned during previous tests conform to the AU Core Encounter
<details>
...
#### 2.18.18 All must support elements are provided in the Encounter resources returned
<details>
...
#### 2.18.19 MustSupport references within Encounter resources are valid
<details>
...
#### 2.19.1 (SHALL) Server returns valid results for Immunization search by patient
<details>
...
#### 2.19.2 (MAY) Server returns valid results for Immunization search by date
<details>
...
#### 2.19.3 (MAY) Server returns valid results for Immunization search by status
<details>
...
#### 2.19.4 (MAY) Server returns valid results for Immunization search by vaccine-code
<details>
...
#### 2.19.5 (SHALL) Server returns valid results for Immunization search by patient + status
<details>
...
#### 2.19.6 (SHOULD) Server returns valid results for Immunization search by patient + date
<details>
...
#### 2.19.7 (MAY) Server returns valid results for Immunization search by patient + vaccine-code
<details>
...
#### 2.19.8 (SHOULD) Server returns valid results for Immunization multipleOr search by vaccine-code
<details>
...
#### 2.19.9 (SHOULD) Server returns valid results for Immunization multipleAnd search by date
<details>
...
#### 2.19.10 (SHOULD) Server returns valid results for Immunization search by patient (chained parameters)
<details>
...
#### 2.19.11 (SHOULD) Server returns valid results for Immunization search by patient (IHI) (chained parameters)
<details>
...
#### 2.19.12 (SHOULD) Server returns valid results for Immunization search by patient (Medicare) (chained parameters)
<details>
...
#### 2.19.13 (SHOULD) Server returns valid results for Immunization search by patient (DVA) (chained parameters)
<details>
...
#### 2.19.14 (SHALL) Server returns correct Immunization resource from Immunization read interaction
<details>
...
#### 2.19.15 Immunization resources returned during previous tests conform to the AU Core Immunization
<details>
...
#### 2.19.16 All must support elements are provided in the Immunization resources returned
<details>
...
#### 2.19.17 MustSupport references within Immunization resources are valid
<details>
...
#### 2.20.1 (SHALL) Server returns valid results for MedicationRequest search by patient
<details>
...
#### 2.20.2 (SHOULD) Server returns valid results for MedicationRequest search by _id
<details>
...
#### 2.20.3 (MAY) Server returns valid results for MedicationRequest search by authoredon
<details>
...
#### 2.20.4 (MAY) Server returns valid results for MedicationRequest search by intent
<details>
...
#### 2.20.5 (MAY) Server returns valid results for MedicationRequest search by status
<details>
...
#### 2.20.6 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent
<details>
...
#### 2.20.7 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent + status
<details>
...
#### 2.20.8 (SHALL) Server returns valid results for MedicationRequest search by patient + status
<details>
...
#### 2.20.9 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent + authoredon
<details>
...
#### 2.20.10 (SHOULD) Server returns valid results for MedicationRequest multipleOr search by intent
<details>
...
#### 2.20.11 (SHALL) Server returns valid results for MedicationRequest multipleOr search by status
<details>
...
#### 2.20.12 (SHOULD) Server returns valid results for MedicationRequest multipleAnd search by authoredon
<details>
...
#### 2.20.13 (SHOULD) Server returns valid results for MedicationRequest search by patient (chained parameters)
<details>
...
#### 2.20.14 (SHOULD) Server returns valid results for MedicationRequest search by patient (IHI) (chained parameters)
<details>
...
#### 2.20.15 (SHOULD) Server returns valid results for MedicationRequest search by patient (Medicare) (chained parameters)
<details>
...
#### 2.20.16 (SHOULD) Server returns valid results for MedicationRequest search by patient (DVA) (chained parameters)
<details>
...
#### 2.20.17 (SHALL) Server returns correct MedicationRequest resource from MedicationRequest read interaction
<details>
...
#### 2.20.18 Server returns Medication resources from MedicationRequest search by patient and MedicationRequest:medication
<details>
...
#### 2.20.19 Server returns Medication resources from MedicationRequest search by _id and MedicationRequest:medication
<details>
...
#### 2.20.20 Server returns Medication resources from MedicationRequest search by patient, intent and MedicationRequest:medication
<details>
...
#### 2.20.21 Server returns Medication resources from MedicationRequest search by patient, intent, status and MedicationRequest:medication
<details>
...
#### 2.20.22 Server returns Medication resources from MedicationRequest search by patient, intent, authoredon and MedicationRequest:medication
<details>
...
#### 2.20.23 MedicationRequest resources returned during previous tests conform to the AU Core MedicationRequest
<details>
...
#### 2.20.24 Medication resources returned during previous tests conform to the AU Core MedicationRequest
<details>
...
#### 2.20.25 All must support elements are provided in the MedicationRequest resources returned
<details>
...
#### 2.20.26 MustSupport references within MedicationRequest resources are valid
<details>
...
## 2.21 MedicationDispense Tests

<details>

<summary>Verify support for the server capabilities required by the AU Core MedicationDispense.</summary>

# Background

The AU Core MedicationDispense sequence verifies that the system under test is
able to provide correct responses for MedicationDispense queries. These queries
must contain resources conforming to the AU Core MedicationDispense as
specified in the AU Core v2.1.0-draft Implementation Guide.
...
#### 2.21.1 (SHALL) Server returns valid results for MedicationDispense search by patient
<details>
...
```bash
GET /MedicationDispense?patient={patient} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/MedicationDispense?patient={patient}
```
...
#### 2.21.2 (MAY) Server returns valid results for MedicationDispense search by status
<details>

<summary>Show details</summary>

A server MAY support searching by
status on the MedicationDispense resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /MedicationDispense?status={status} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/MedicationDispense?status={status}
```
...
#### 2.21.3 (MAY) Server returns valid results for MedicationDispense search by prescription
<details>

<summary>Show details</summary>

A server MAY support searching by
prescription on the MedicationDispense resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /MedicationDispense?prescription={prescription} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/MedicationDispense?prescription={prescription}
```
...
#### 2.21.4 (SHOULD) Server returns valid results for MedicationDispense search by patient + status
<details>
...
```bash
GET /MedicationDispense?patient status={patient status} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/MedicationDispense?patient status={patient status}
```
...
#### 2.21.5 (SHOULD) Server returns valid results for MedicationDispense search by patient (chained parameters)
<details>

<summary>Show details</summary>

A server SHOULD support searching by
patient:Patient.identifier on the MedicationDispense resource. This test
will pass if the server returns a success response to the request.
...
```bash
GET /MedicationDispense?patient:Patient.identifier={patient:Patient.identifier} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/MedicationDispense?patient:Patient.identifier={patient:Patient.identifier}
```
...
#### 2.21.6 (SHOULD) Server returns valid results for MedicationDispense search by patient (IHI) (chained parameters)
<details>
...
#### 2.21.7 (SHOULD) Server returns valid results for MedicationDispense search by patient (Medicare) (chained parameters)
<details>
...
#### 2.21.8 (SHOULD) Server returns valid results for MedicationDispense search by patient (DVA) (chained parameters)
<details>
...
#### 2.21.9 (SHALL) Server returns correct MedicationDispense resource from MedicationDispense read interaction
<details>

<summary>Show details</summary>

A server SHALL support the MedicationDispense read interaction.
...
#### 2.21.10 MedicationDispense resources returned during previous tests conform to the AU Core MedicationDispense
<details>

<summary>Show details</summary>

This test verifies resources returned from the first search conform to
the [AU Core MedicationDispense](http://hl7.org.au/fhir/core/StructureDefinition/au-core-medicationdispense
...
#### 2.21.11 All must support elements are provided in the MedicationDispense resources returned
<details>
...
#### 2.21.12 MustSupport references within MedicationDispense resources are valid
<details>
...
## 2.22 MedicationStatement Tests
...
#### 2.22.1 (SHALL) Server returns valid results for MedicationStatement search by patient
<details>
...
#### 2.22.2 (SHOULD) Server returns valid results for MedicationStatement search by _id
<details>
...
#### 2.22.3 (MAY) Server returns valid results for MedicationStatement search by effective
<details>
...
#### 2.22.4 (MAY) Server returns valid results for MedicationStatement search by status
<details>
...
#### 2.22.5 (SHALL) Server returns valid results for MedicationStatement search by patient + status
<details>
...
#### 2.22.6 (SHOULD) Server returns valid results for MedicationStatement search by patient + effective
<details>
...
#### 2.22.7 (SHOULD) Server returns valid results for MedicationStatement search by patient (chained parameters)
<details>
...
#### 2.22.8 (SHOULD) Server returns valid results for MedicationStatement search by patient (IHI) (chained parameters)
<details>
...
#### 2.22.9 (SHOULD) Server returns valid results for MedicationStatement search by patient (Medicare) (chained parameters)
<details>
...
#### 2.22.10 (SHOULD) Server returns valid results for MedicationStatement search by patient (DVA) (chained parameters)
<details>
...
#### 2.22.11 (SHALL) Server returns correct MedicationStatement resource from MedicationStatement read interaction
<details>
...
#### 2.22.12 MedicationStatement resources returned during previous tests conform to the AU Core MedicationStatement
<details>
...
#### 2.22.13 All must support elements are provided in the MedicationStatement resources returned
<details>
...
#### 2.22.14 MustSupport references within MedicationStatement resources are valid
<details>
...
#### 2.23.1 (SHALL) Server returns valid results for Procedure search by patient
<details>
...
#### 2.23.2 (MAY) Server returns valid results for Procedure search by code
<details>
...
#### 2.23.3 (MAY) Server returns valid results for Procedure search by date
<details>
...
#### 2.23.4 (MAY) Server returns valid results for Procedure search by status
<details>
...
#### 2.23.5 (SHALL) Server returns valid results for Procedure search by patient + date
<details>
...
#### 2.23.6 (SHOULD) Server returns valid results for Procedure search by patient + code + date
<details>
...
#### 2.23.7 (SHOULD) Server returns valid results for Procedure search by patient + status
<details>
...
#### 2.23.8 (SHOULD) Server returns valid results for Procedure multipleOr search by code
<details>
...
#### 2.23.9 (SHOULD) Server returns valid results for Procedure multipleOr search by status
<details>
...
#### 2.23.10 (MAY) Server returns valid results for Procedure multipleAnd search by date
<details>
...
#### 2.23.11 (SHOULD) Server returns valid results for Procedure search by patient (chained parameters)
<details>
...
#### 2.23.12 (SHOULD) Server returns valid results for Procedure search by patient (IHI) (chained parameters)
<details>
...
#### 2.23.13 (SHOULD) Server returns valid results for Procedure search by patient (Medicare) (chained parameters)
<details>
...
#### 2.23.14 (SHOULD) Server returns valid results for Procedure search by patient (DVA) (chained parameters)
<details>
...
#### 2.23.15 (SHALL) Server returns correct Procedure resource from Procedure read interaction
<details>
...
#### 2.23.16 Procedure resources returned during previous tests conform to the AU Core Procedure
<details>
...
#### 2.23.17 All must support elements are provided in the Procedure resources returned
<details>
...
#### 2.23.18 MustSupport references within Procedure resources are valid
<details>
...
#### 2.24.1 (SHALL) Server returns valid results for RelatedPerson search by patient
<details>
...
#### 2.24.2 (SHOULD) Server returns valid results for RelatedPerson search by _id
<details>
...
#### 2.24.3 (MAY) Server returns valid results for RelatedPerson search by name
<details>
...
#### 2.24.4 (MAY) Server returns valid results for RelatedPerson search by relationship
<details>
...
#### 2.24.5 (SHOULD) Server returns valid results for RelatedPerson search by patient + relationship
<details>
...
#### 2.24.6 (SHOULD) Server returns valid results for RelatedPerson search by patient + name
<details>
...
#### 2.24.7 (SHALL) Server returns correct RelatedPerson resource from RelatedPerson read interaction
<details>
...
#### 2.24.8 RelatedPerson resources returned during previous tests conform to the AU Core RelatedPerson
<details>
...
#### 2.24.9 All must support elements are provided in the RelatedPerson resources returned
<details>
...
#### 2.24.10 MustSupport references within RelatedPerson resources are valid
<details>
...
<summary>Verify support for the server capabilities required by the AU Core Endpoint.</summary>
...
the [AU Core Endpoint](http://hl7.org.au/fhir/core/StructureDefinition/au-core-endpoint
...
#### 2.25.1 (SHALL) Server returns correct Endpoint resource from Endpoint read interaction
<details>

<summary>Show details</summary>

A server SHALL support the Endpoint read interaction.
...
#### 2.25.2 (SHOULD) Server returns valid results for Endpoint search by _id
<details>
...
```bash
{test endpoint}/Endpoint?_id={_id}
```
...
#### 2.25.3 (MAY) Server returns valid results for Endpoint search by status
<details>

<summary>Show details</summary>

A server MAY support searching by
status on the Endpoint resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /Endpoint?status={status} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Endpoint?status={status}
```
...
#### 2.25.4 (MAY) Server returns valid results for Endpoint search by connection-type
<details>
...
```bash
GET /Endpoint?connection-type={connection-type} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Endpoint?connection-type={connection-type}
```
...
#### 2.25.5 (MAY) Server returns valid results for Endpoint search by payload-type
<details>

<summary>Show details</summary>

A server MAY support searching by
payload-type on the Endpoint resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /Endpoint?payload-type={payload-type} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Endpoint?payload-type={payload-type}
```
...
#### 2.25.6 (MAY) Server returns valid results for Endpoint search by name
<details>

<summary>Show details</summary>

A server MAY support searching by
name on the Endpoint resource. This test
will pass if resources are returned and match the search criteria. If
none are returned, the test is skipped.
...
```bash
GET /Endpoint?name={name} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/Endpoint?name={name}
```
...
#### 2.25.7 Endpoint resources returned during previous tests conform to the AU Core Endpoint
<details>
...
#### 2.25.8 All must support elements are provided in the Endpoint resources returned
<details>
...
## 2.26 HealthcareService Tests

<details>

<summary>Verify support for the server capabilities required by the AU Core HealthcareService.</summary>
...
#### 2.26.1 (SHALL) Server returns correct HealthcareService resource from HealthcareService read interaction
<details>

<summary>Show details</summary>

A server SHALL support the HealthcareService read interaction.
...
#### 2.26.2 (SHOULD) Server returns valid results for HealthcareService search by _id
<details>
...
```bash
GET /HealthcareService?_id={_id} HTTP/1.1
User-Agent: {agent}
Host: {host}
Accept: application/fhir+json
```
...
```bash
{test endpoint}/HealthcareService?_id={_id}
```
...
#### 2.26.3 (SHALL) Server returns valid results for HealthcareService search by name
<details>
...
#### 2.26.4 (SHOULD) Server returns valid results for HealthcareService search by identifier
<details>
...
#### 2.26.5 (SHOULD) Server returns valid results for HealthcareService search by service-type
<details>
...
#### 2.26.6 HealthcareService resources returned during previous tests conform to the AU Core HealthcareService
<details>
...
#### 2.26.7 All must support elements are provided in the HealthcareService resources returned
<details>
...
#### 2.27.1 (SHALL) Server returns correct Location resource from Location read interaction
<details>
...
#### 2.27.2 (SHOULD) Server returns valid results for Location search by address
<details>
...
#### 2.27.3 (SHALL) Server returns valid results for Location search by name
<details>
...
#### 2.27.4 (SHOULD) Server returns valid results for Location search by address-city
<details>
...
#### 2.27.5 (SHOULD) Server returns valid results for Location search by address-state
<details>
...
#### 2.27.6 (SHOULD) Server returns valid results for Location search by address-postalcode
<details>
...
#### 2.27.7 Location resources returned during previous tests conform to the AU Core Location
<details>
...
#### 2.27.8 All must support elements are provided in the Location resources returned
<details>
...
#### 2.27.9 MustSupport references within Location resources are valid
<details>
...
#### 2.28.1 (SHALL) Server returns correct Organization resource from Organization read interaction
<details>
...
#### 2.28.2 (SHOULD) Server returns valid results for Organization search by _id
<details>
...
#### 2.28.3 (SHOULD) Server returns valid results for Organization search by address
<details>
...
#### 2.28.4 (SHALL) Server returns valid results for Organization search by identifier
<details>
...
#### 2.28.5 (SHALL) Server returns valid results for Organization search by name
<details>
...
#### 2.28.6 (SHOULD) Server returns valid results for Organization search by identifier (HPI-O)
<details>
...
#### 2.28.7 (SHOULD) Server returns valid results for Organization search by identifier (ABN)
<details>
...
#### 2.28.8 Organization resources returned during previous tests conform to the AU Core Organization
<details>
...
#### 2.28.9 All must support elements are provided in the Organization resources returned
<details>
...
#### 2.29.1 (SHALL) Server returns correct Practitioner resource from Practitioner read interaction
<details>
...
#### 2.29.2 (SHOULD) Server returns valid results for Practitioner search by _id
<details>
...
#### 2.29.3 (SHALL) Server returns valid results for Practitioner search by identifier
<details>
...
#### 2.29.4 (SHOULD) Server returns valid results for Practitioner search by name
<details>
...
#### 2.29.5 (SHOULD) Server returns valid results for Practitioner search by identifier (HPI-I)
<details>
...
#### 2.29.6 Practitioner resources returned during previous tests conform to the AU Core Practitioner
<details>
...
#### 2.29.7 All must support elements are provided in the Practitioner resources returned
<details>
...
#### 2.30.1 (SHALL) Server returns correct PractitionerRole resource from PractitionerRole read interaction
<details>
...
#### 2.30.2 (SHOULD) Server returns valid results for PractitionerRole search by _id
<details>
...
#### 2.30.3 (SHALL) Server returns valid results for PractitionerRole search by identifier
<details>
...
#### 2.30.4 (SHALL) Server returns valid results for PractitionerRole search by practitioner
<details>
...
#### 2.30.5 (SHOULD) Server returns valid results for PractitionerRole search by specialty
<details>
...
#### 2.30.6 (SHOULD) Server returns valid results for PractitionerRole search by role
<details>
...
#### 2.30.7 (MAY) Server returns valid results for PractitionerRole search by organization
<details>
...
#### 2.30.8 (MAY) Server returns valid results for PractitionerRole multipleOr search by practitioner
<details>
...
#### 2.30.9 (MAY) Server returns valid results for PractitionerRole multipleAnd search by practitioner
<details>
...
#### 2.30.10 (SHOULD) Server returns valid results for PractitionerRole search by practitioner (chained parameters)
<details>
...
#### 2.30.11 (SHOULD) Server returns valid results for PractitionerRole search by identifier (Medicare)
<details>
...
#### 2.30.12 Server returns Practitioner resources from PractitionerRole search by _id and PractitionerRole:practitioner
<details>
...
#### 2.30.13 Server returns Practitioner resources from PractitionerRole search by identifier and PractitionerRole:practitioner
<details>
...
#### 2.30.14 Server returns Practitioner resources from PractitionerRole search by practitioner and PractitionerRole:practitioner
<details>
...
#### 2.30.15 Server returns Practitioner resources from PractitionerRole search by specialty and PractitionerRole:practitioner
<details>
...
#### 2.30.16 PractitionerRole resources returned during previous tests conform to the AU Core PractitionerRole
<details>
...
#### 2.30.17 All must support elements are provided in the PractitionerRole resources returned
<details>
...
#### 2.30.18 MustSupport references within PractitionerRole resources are valid
<details>
