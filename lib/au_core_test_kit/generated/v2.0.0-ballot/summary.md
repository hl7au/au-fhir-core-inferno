...
#### 3.2.8 (MAY) Server returns valid results for Patient search by gender-identity
<details>
...
#### 3.2.14 (MAY) Server returns valid results for Patient multipleOr search by gender-identity
<details>
...
#### 3.2.15 (MAY) Server returns valid results for Patient multipleAnd search by birthdate
<details>
...
#### 3.2.16 (MAY) Server returns valid results for Patient multipleAnd search by indigenous-status
<details>
...
#### 3.2.17 (MAY) Server returns valid results for Patient multipleAnd search by gender-identity
<details>
...
#### 3.2.18 (SHOULD) Server returns valid results for Patient search by identifier (IHI)
<details>
...
#### 3.2.19 (SHOULD) Server returns valid results for Patient search by identifier (Medicare)
<details>
...
#### 3.2.20 (SHOULD) Server returns valid results for Patient search by identifier (DVA)
<details>
...
#### 3.2.21 (SHALL) Server returns correct Patient resource from Patient read interaction
<details>
...
#### 3.3.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 3.3.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.3.12 (SHOULD) Server returns valid results for Observation multipleOr search by status
<details>
...
#### 3.3.19 Observation resources returned during previous tests conform to the AU Core Body Weight
<details>
...
#### 3.3.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.3.21 MustSupport references within Observation resources are valid
<details>
...
#### 3.4.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 3.4.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.4.12 (SHOULD) Server returns valid results for Observation multipleOr search by status
<details>
...
#### 3.4.19 Observation resources returned during previous tests conform to the AU Core Blood Pressure
<details>
...
#### 3.4.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.4.21 MustSupport references within Observation resources are valid
<details>
...
#### 3.5.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 3.5.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.5.12 (SHOULD) Server returns valid results for Observation multipleOr search by status
<details>
...
#### 3.5.19 Observation resources returned during previous tests conform to the AU Core Body Height
<details>
...
#### 3.5.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.5.21 MustSupport references within Observation resources are valid
<details>
...
#### 3.6.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 3.6.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.6.12 (SHOULD) Server returns valid results for Observation multipleOr search by status
<details>
...
#### 3.6.19 Observation resources returned during previous tests conform to the AU Core Pathology Result Observation
<details>
...
#### 3.6.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.6.21 MustSupport references within Observation resources are valid
<details>
...
#### 3.7.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 3.7.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.7.12 (SHOULD) Server returns valid results for Observation multipleOr search by status
<details>
...
#### 3.7.19 Observation resources returned during previous tests conform to the AU Core Body Temperature
<details>
...
#### 3.7.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.7.21 MustSupport references within Observation resources are valid
<details>
...
#### 3.8.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 3.8.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.8.12 (SHOULD) Server returns valid results for Observation multipleOr search by status
<details>
...
#### 3.8.19 Observation resources returned during previous tests conform to the AU Core Heart Rate
<details>
...
#### 3.8.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.8.21 MustSupport references within Observation resources are valid
<details>
...
#### 3.9.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 3.9.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.9.12 (SHOULD) Server returns valid results for Observation multipleOr search by status
<details>
...
#### 3.9.19 Observation resources returned during previous tests conform to the AU Core Waist Circumference
<details>
...
#### 3.9.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.9.21 MustSupport references within Observation resources are valid
<details>
...
#### 3.10.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 3.10.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.10.12 (SHOULD) Server returns valid results for Observation multipleOr search by status
<details>
...
#### 3.10.19 Observation resources returned during previous tests conform to the AU Core Respiration Rate
<details>
...
#### 3.10.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.10.21 MustSupport references within Observation resources are valid
<details>
...
#### 3.11.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 3.11.7 (SHALL) Server returns valid results for Observation search by patient + category
<details>
...
#### 3.11.8 (SHALL) Server returns valid results for Observation search by patient + category + date
<details>
...
#### 3.11.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.11.12 (SHOULD) Server returns valid results for Observation multipleOr search by status
<details>
...
#### 3.11.19 Observation resources returned during previous tests conform to the AU Core Diagnostic Result Observation
<details>
...
#### 3.11.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.11.21 MustSupport references within Observation resources are valid
<details>
...
#### 3.12.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 3.12.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 3.12.12 (SHOULD) Server returns valid results for Observation multipleOr search by status
<details>
...
#### 3.12.19 Observation resources returned during previous tests conform to the AU Core Smoking Status
<details>
...
#### 3.12.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 3.12.21 MustSupport references within Observation resources are valid
<details>
...
#### 3.13.9 AllergyIntolerance resources returned during previous tests conform to the AU Core AllergyIntolerance
<details>
...
#### 3.13.10 All must support elements are provided in the AllergyIntolerance resources returned
<details>
...
#### 3.13.11 MustSupport references within AllergyIntolerance resources are valid
<details>
...
#### 3.14.11 (MAY) Server returns valid results for Condition multipleOr search by code
<details>
...
#### 3.14.12 (SHOULD) Server returns valid results for Condition multipleAnd search by onset-date
<details>
...
#### 3.14.13 (SHOULD) Server returns valid results for Condition search by patient (chained parameters)
<details>
...
#### 3.14.14 (SHOULD) Server returns valid results for Condition search by patient (IHI) (chained parameters)
<details>
...
#### 3.14.15 (SHOULD) Server returns valid results for Condition search by patient (Medicare) (chained parameters)
<details>
...
#### 3.14.16 (SHOULD) Server returns valid results for Condition search by patient (DVA) (chained parameters)
<details>
...
#### 3.14.17 (SHALL) Server returns correct Condition resource from Condition read interaction
<details>
...
#### 3.15.4 (MAY) Server returns valid results for Encounter search by location
<details>
...
#### 3.15.5 (MAY) Server returns valid results for Encounter search by status
<details>
...
#### 3.15.6 (SHALL) Server returns valid results for Encounter search by date + patient
<details>
...
#### 3.15.7 (SHOULD) Server returns valid results for Encounter search by class + patient
<details>
...
#### 3.15.8 (SHOULD) Server returns valid results for Encounter search by patient + location
<details>
...
#### 3.15.9 (SHOULD) Server returns valid results for Encounter search by patient + status
<details>
...
#### 3.15.10 (MAY) Server returns valid results for Encounter multipleOr search by status
<details>
...
#### 3.15.11 (SHOULD) Server returns valid results for Encounter multipleAnd search by date
<details>
...
#### 3.15.12 (SHOULD) Server returns valid results for Encounter search by patient (chained parameters)
<details>
...
#### 3.15.13 (SHOULD) Server returns valid results for Encounter search by patient (IHI) (chained parameters)
<details>
...
#### 3.15.14 (SHOULD) Server returns valid results for Encounter search by patient (Medicare) (chained parameters)
<details>
...
#### 3.15.15 (SHOULD) Server returns valid results for Encounter search by patient (DVA) (chained parameters)
<details>
...
#### 3.15.16 (SHALL) Server returns correct Encounter resource from Encounter read interaction
<details>
...
#### 3.15.17 Encounter resources returned during previous tests conform to the AU Core Encounter
<details>
...
#### 3.15.18 All must support elements are provided in the Encounter resources returned
<details>
...
#### 3.15.19 MustSupport references within Encounter resources are valid
<details>
...
#### 3.16.15 Immunization resources returned during previous tests conform to the AU Core Immunization
<details>
...
#### 3.16.16 All must support elements are provided in the Immunization resources returned
<details>
...
#### 3.16.17 MustSupport references within Immunization resources are valid
<details>
...
#### 3.17.2 (SHOULD) Server returns valid results for MedicationRequest search by _id
<details>
...
#### 3.17.3 (MAY) Server returns valid results for MedicationRequest search by authoredon
<details>
...
#### 3.17.4 (MAY) Server returns valid results for MedicationRequest search by intent
<details>
...
#### 3.17.5 (MAY) Server returns valid results for MedicationRequest search by status
<details>
...
#### 3.17.6 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent
<details>
...
#### 3.17.7 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent + status
<details>
...
#### 3.17.8 (SHALL) Server returns valid results for MedicationRequest search by patient + status
<details>
...
#### 3.17.9 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent + authoredon
<details>
...
#### 3.17.10 (SHOULD) Server returns valid results for MedicationRequest multipleOr search by intent
<details>
...
#### 3.17.11 (SHALL) Server returns valid results for MedicationRequest multipleOr search by status
<details>
...
#### 3.17.12 (SHOULD) Server returns valid results for MedicationRequest multipleAnd search by authoredon
<details>
...
#### 3.17.13 (SHOULD) Server returns valid results for MedicationRequest search by patient (chained parameters)
<details>
...
#### 3.17.14 (SHOULD) Server returns valid results for MedicationRequest search by patient (IHI) (chained parameters)
<details>
...
#### 3.17.15 (SHOULD) Server returns valid results for MedicationRequest search by patient (Medicare) (chained parameters)
<details>
...
#### 3.17.16 (SHOULD) Server returns valid results for MedicationRequest search by patient (DVA) (chained parameters)
<details>
...
#### 3.17.17 (SHALL) Server returns correct MedicationRequest resource from MedicationRequest read interaction
<details>
...
#### 3.17.18 Server returns Medication resources from MedicationRequest search by patient and MedicationRequest:medication
<details>
...
#### 3.17.19 Server returns Medication resources from MedicationRequest search by _id and MedicationRequest:medication
<details>
...
#### 3.17.20 Server returns Medication resources from MedicationRequest search by patient, intent and MedicationRequest:medication
<details>
...
#### 3.17.21 Server returns Medication resources from MedicationRequest search by patient, intent, status and MedicationRequest:medication
<details>
...
#### 3.17.22 Server returns Medication resources from MedicationRequest search by patient, intent, authoredon and MedicationRequest:medication
<details>
...
#### 3.17.23 MedicationRequest resources returned during previous tests conform to the AU Core MedicationRequest
<details>
...
#### 3.17.24 Medication resources returned during previous tests conform to the AU Core Medication
<details>
...
#### 3.17.25 All must support elements are provided in the MedicationRequest resources returned
<details>
...
#### 3.17.26 MustSupport references within MedicationRequest resources are valid
<details>
...
#### 3.18.2 (SHOULD) Server returns valid results for MedicationStatement search by _id
<details>
...
#### 3.18.3 (MAY) Server returns valid results for MedicationStatement search by effective
<details>
...
#### 3.18.4 (MAY) Server returns valid results for MedicationStatement search by status
<details>
...
#### 3.18.5 (SHALL) Server returns valid results for MedicationStatement search by patient + status
<details>
...
#### 3.18.6 (SHOULD) Server returns valid results for MedicationStatement search by patient + effective
<details>
...
#### 3.18.7 (SHOULD) Server returns valid results for MedicationStatement search by patient (chained parameters)
<details>
...
#### 3.18.8 (SHOULD) Server returns valid results for MedicationStatement search by patient (IHI) (chained parameters)
<details>
...
#### 3.18.9 (SHOULD) Server returns valid results for MedicationStatement search by patient (Medicare) (chained parameters)
<details>
...
#### 3.18.10 (SHOULD) Server returns valid results for MedicationStatement search by patient (DVA) (chained parameters)
<details>
...
#### 3.18.11 (SHALL) Server returns correct MedicationStatement resource from MedicationStatement read interaction
<details>
...
#### 3.19.9 (SHOULD) Server returns valid results for Procedure multipleOr search by status
<details>
...
#### 3.19.10 (MAY) Server returns valid results for Procedure multipleAnd search by date
<details>
...
#### 3.19.11 (SHOULD) Server returns valid results for Procedure search by patient (chained parameters)
<details>
...
#### 3.19.12 (SHOULD) Server returns valid results for Procedure search by patient (IHI) (chained parameters)
<details>
...
#### 3.19.13 (SHOULD) Server returns valid results for Procedure search by patient (Medicare) (chained parameters)
<details>
...
#### 3.19.14 (SHOULD) Server returns valid results for Procedure search by patient (DVA) (chained parameters)
<details>
...
#### 3.19.15 (SHALL) Server returns correct Procedure resource from Procedure read interaction
<details>
...
#### 3.20.1 (SHALL) Server returns valid results for RelatedPerson search by patient
<details>
...
#### 3.20.2 (SHOULD) Server returns valid results for RelatedPerson search by _id
<details>
...
#### 3.20.3 (MAY) Server returns valid results for RelatedPerson search by name
<details>
...
#### 3.20.4 (MAY) Server returns valid results for RelatedPerson search by relationship
<details>
...
#### 3.20.5 (SHOULD) Server returns valid results for RelatedPerson search by patient + relationship
<details>
...
#### 3.20.6 (SHOULD) Server returns valid results for RelatedPerson search by patient + name
<details>
...
#### 3.20.7 (SHALL) Server returns correct RelatedPerson resource from RelatedPerson read interaction
<details>
...
#### 3.20.8 RelatedPerson resources returned during previous tests conform to the AU Core RelatedPerson
<details>
...
#### 3.20.9 All must support elements are provided in the RelatedPerson resources returned
<details>
...
#### 3.20.10 MustSupport references within RelatedPerson resources are valid
<details>
...
#### 3.21.1 (SHALL) Server returns correct HealthcareService resource from HealthcareService read interaction
<details>
...
#### 3.21.2 (SHALL) Server returns valid results for HealthcareService search by name
<details>
...
#### 3.21.3 (SHOULD) Server returns valid results for HealthcareService search by identifier
<details>
...
#### 3.21.4 (SHOULD) Server returns valid results for HealthcareService search by _id
<details>
...
#### 3.21.5 (SHOULD) Server returns valid results for HealthcareService search by service-type
<details>
...
#### 3.21.6 HealthcareService resources returned during previous tests conform to the AU Core HealthcareService
<details>
...
#### 3.21.7 All must support elements are provided in the HealthcareService resources returned
<details>
...
#### 3.22.1 (SHALL) Server returns correct Location resource from Location read interaction
<details>
...
#### 3.22.2 (SHOULD) Server returns valid results for Location search by address
<details>
...
#### 3.22.3 (SHALL) Server returns valid results for Location search by name
<details>
...
#### 3.22.4 (SHOULD) Server returns valid results for Location search by address-city
<details>
...
#### 3.22.5 (SHOULD) Server returns valid results for Location search by address-state
<details>
...
#### 3.22.6 (SHOULD) Server returns valid results for Location search by address-postalcode
<details>
...
#### 3.22.7 Location resources returned during previous tests conform to the AU Core Location
<details>
...
#### 3.22.8 All must support elements are provided in the Location resources returned
<details>
...
#### 3.22.9 MustSupport references within Location resources are valid
<details>
...
#### 3.23.1 (SHALL) Server returns correct Organization resource from Organization read interaction
<details>
...
#### 3.23.2 (SHOULD) Server returns valid results for Organization search by _id
<details>
...
#### 3.23.3 (SHOULD) Server returns valid results for Organization search by address
<details>
...
#### 3.23.4 (SHALL) Server returns valid results for Organization search by identifier
<details>
...
#### 3.23.5 (SHALL) Server returns valid results for Organization search by name
<details>
...
#### 3.23.6 (SHOULD) Server returns valid results for Organization search by identifier (HPI-O)
<details>
...
#### 3.23.7 (SHOULD) Server returns valid results for Organization search by identifier (ABN)
<details>
...
#### 3.23.8 Organization resources returned during previous tests conform to the AU Core Organization
<details>
...
#### 3.23.9 All must support elements are provided in the Organization resources returned
<details>
...
#### 3.24.1 (SHALL) Server returns correct Practitioner resource from Practitioner read interaction
<details>
...
#### 3.24.2 (SHOULD) Server returns valid results for Practitioner search by _id
<details>
...
#### 3.24.3 (SHALL) Server returns valid results for Practitioner search by identifier
<details>
...
#### 3.24.4 (SHOULD) Server returns valid results for Practitioner search by name
<details>
...
#### 3.24.5 (SHOULD) Server returns valid results for Practitioner search by identifier (HPI-I)
<details>
...
#### 3.24.6 Practitioner resources returned during previous tests conform to the AU Core Practitioner
<details>
...
#### 3.24.7 All must support elements are provided in the Practitioner resources returned
<details>
...
#### 3.25.1 (SHALL) Server returns correct PractitionerRole resource from PractitionerRole read interaction
<details>
...
#### 3.25.2 (SHOULD) Server returns valid results for PractitionerRole search by _id
<details>
...
#### 3.25.3 (SHALL) Server returns valid results for PractitionerRole search by identifier
<details>
...
#### 3.25.4 (SHALL) Server returns valid results for PractitionerRole search by practitioner
<details>
...
#### 3.25.5 (SHOULD) Server returns valid results for PractitionerRole search by specialty
<details>
...
#### 3.25.6 (SHOULD) Server returns valid results for PractitionerRole search by role
<details>
...
#### 3.25.7 (MAY) Server returns valid results for PractitionerRole search by organization
<details>
...
#### 3.25.8 (MAY) Server returns valid results for PractitionerRole multipleOr search by practitioner
<details>
...
#### 3.25.9 (MAY) Server returns valid results for PractitionerRole multipleAnd search by practitioner
<details>
...
#### 3.25.10 (SHOULD) Server returns valid results for PractitionerRole search by practitioner (chained parameters)
<details>
...
#### 3.25.11 (SHOULD) Server returns valid results for PractitionerRole search by identifier (Medicare)
<details>
...
#### 3.25.12 Server returns Practitioner resources from PractitionerRole search by _id and PractitionerRole:practitioner
<details>
...
#### 3.25.13 Server returns Practitioner resources from PractitionerRole search by identifier and PractitionerRole:practitioner
<details>
...
#### 3.25.14 Server returns Practitioner resources from PractitionerRole search by practitioner and PractitionerRole:practitioner
<details>
...
#### 3.25.15 Server returns Practitioner resources from PractitionerRole search by specialty and PractitionerRole:practitioner
<details>
...
#### 3.25.16 PractitionerRole resources returned during previous tests conform to the AU Core PractitionerRole
<details>
...
#### 3.25.17 All must support elements are provided in the PractitionerRole resources returned
<details>
...
#### 3.25.18 MustSupport references within PractitionerRole resources are valid
<details>
