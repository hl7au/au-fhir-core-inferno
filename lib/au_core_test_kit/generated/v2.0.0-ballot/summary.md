...
specified in the AU Core v2.0.0-ballot Implementation Guide.
...
requirement of AU Core v2.0.0-ballot.
...
#### 1.2.15 (MAY) Server returns valid results for Patient multipleAnd search by birthdate
<details>
...
#### 1.2.16 (MAY) Server returns valid results for Patient multipleAnd search by indigenous-status
<details>
...
#### 1.2.17 (MAY) Server returns valid results for Patient multipleAnd search by gender-identity
<details>
...
#### 1.2.18 (SHOULD) Server returns valid results for Patient search by identifier (IHI)
<details>
...
#### 1.2.19 (SHOULD) Server returns valid results for Patient search by identifier (Medicare)
<details>
...
#### 1.2.20 (SHOULD) Server returns valid results for Patient search by identifier (DVA)
<details>
...
#### 1.2.21 (SHALL) Server returns correct Patient resource from Patient read interaction
<details>
...
#### 1.3.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 1.4.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 1.5.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 1.6.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 1.7.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 1.8.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 1.9.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 1.9.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.9.19 Observation resources returned during previous tests conform to the AU Core Waist Circumference
<details>
...
#### 1.9.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.9.21 MustSupport references within Observation resources are valid
<details>
...
#### 1.10.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 1.10.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.10.19 Observation resources returned during previous tests conform to the AU Core Respiration Rate
<details>
...
#### 1.10.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.10.21 MustSupport references within Observation resources are valid
<details>
...
#### 1.11.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 1.11.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.11.19 Observation resources returned during previous tests conform to the AU Core Diagnostic Result Observation
<details>
...
#### 1.11.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.11.21 MustSupport references within Observation resources are valid
<details>
...
#### 1.12.6 (MAY) Server returns valid results for Observation search by patient
<details>
...
#### 1.12.9 (SHOULD) Server returns valid results for Observation search by patient + category + status
<details>
...
#### 1.12.19 Observation resources returned during previous tests conform to the AU Core Smoking Status
<details>
...
#### 1.12.20 All must support elements are provided in the Observation resources returned
<details>
...
#### 1.12.21 MustSupport references within Observation resources are valid
<details>
...
#### 1.13.9 AllergyIntolerance resources returned during previous tests conform to the AU Core AllergyIntolerance
<details>
...
#### 1.13.10 All must support elements are provided in the AllergyIntolerance resources returned
<details>
...
#### 1.13.11 MustSupport references within AllergyIntolerance resources are valid
<details>
...
#### 1.14.11 (MAY) Server returns valid results for Condition multipleOr search by code
<details>
...
#### 1.14.12 (SHOULD) Server returns valid results for Condition multipleAnd search by onset-date
<details>
...
#### 1.14.13 (SHOULD) Server returns valid results for Condition search by patient (chained parameters)
<details>
...
#### 1.14.14 (SHOULD) Server returns valid results for Condition search by patient (IHI) (chained parameters)
<details>
...
#### 1.14.15 (SHOULD) Server returns valid results for Condition search by patient (Medicare) (chained parameters)
<details>
...
#### 1.14.16 (SHOULD) Server returns valid results for Condition search by patient (DVA) (chained parameters)
<details>
...
#### 1.14.17 (SHALL) Server returns correct Condition resource from Condition read interaction
<details>
...
#### 1.15.4 (MAY) Server returns valid results for Encounter search by location
<details>
...
#### 1.15.5 (MAY) Server returns valid results for Encounter search by status
<details>
...
#### 1.15.6 (SHALL) Server returns valid results for Encounter search by date + patient
<details>
...
#### 1.15.7 (SHOULD) Server returns valid results for Encounter search by class + patient
<details>
...
#### 1.15.8 (SHOULD) Server returns valid results for Encounter search by patient + location
<details>
...
#### 1.15.9 (SHOULD) Server returns valid results for Encounter search by patient + status
<details>
...
#### 1.16.15 Immunization resources returned during previous tests conform to the AU Core Immunization
<details>
...
#### 1.16.16 All must support elements are provided in the Immunization resources returned
<details>
...
#### 1.16.17 MustSupport references within Immunization resources are valid
<details>
...
#### 1.17.2 (SHOULD) Server returns valid results for MedicationRequest search by _id
<details>
...
#### 1.17.3 (MAY) Server returns valid results for MedicationRequest search by authoredon
<details>
...
#### 1.17.4 (MAY) Server returns valid results for MedicationRequest search by intent
<details>
...
#### 1.17.5 (MAY) Server returns valid results for MedicationRequest search by status
<details>
...
#### 1.17.6 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent
<details>
...
#### 1.17.7 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent + status
<details>
...
#### 1.17.8 (SHALL) Server returns valid results for MedicationRequest search by patient + status
<details>
...
#### 1.17.9 (SHOULD) Server returns valid results for MedicationRequest search by patient + intent + authoredon
<details>
...
#### 1.17.10 (SHOULD) Server returns valid results for MedicationRequest multipleOr search by intent
<details>
...
#### 1.17.11 (SHALL) Server returns valid results for MedicationRequest multipleOr search by status
<details>
...
#### 1.17.12 (SHOULD) Server returns valid results for MedicationRequest multipleAnd search by authoredon
<details>
...
#### 1.17.13 (SHOULD) Server returns valid results for MedicationRequest search by patient (chained parameters)
<details>
...
#### 1.17.14 (SHOULD) Server returns valid results for MedicationRequest search by patient (IHI) (chained parameters)
<details>
...
#### 1.17.15 (SHOULD) Server returns valid results for MedicationRequest search by patient (Medicare) (chained parameters)
<details>
...
#### 1.17.16 (SHOULD) Server returns valid results for MedicationRequest search by patient (DVA) (chained parameters)
<details>
...
#### 1.17.17 (SHALL) Server returns correct MedicationRequest resource from MedicationRequest read interaction
<details>
...
#### 1.17.18 Server returns Medication resources from MedicationRequest search by patient and MedicationRequest:medication
<details>
...
#### 1.17.19 Server returns Medication resources from MedicationRequest search by _id and MedicationRequest:medication
<details>
...
#### 1.17.20 Server returns Medication resources from MedicationRequest search by patient, intent and MedicationRequest:medication
<details>
...
#### 1.17.21 Server returns Medication resources from MedicationRequest search by patient, intent, status and MedicationRequest:medication
<details>
...
#### 1.17.22 Server returns Medication resources from MedicationRequest search by patient, intent, authoredon and MedicationRequest:medication
<details>
...
#### 1.17.23 MedicationRequest resources returned during previous tests conform to the AU Core MedicationRequest
<details>
...
#### 1.17.24 Medication resources returned during previous tests conform to the AU Core Medication
<details>
...
#### 1.17.25 All must support elements are provided in the MedicationRequest resources returned
<details>
...
#### 1.17.26 MustSupport references within MedicationRequest resources are valid
<details>
...
#### 1.18.2 (SHOULD) Server returns valid results for MedicationStatement search by _id
<details>
...
#### 1.18.3 (MAY) Server returns valid results for MedicationStatement search by effective
<details>
...
#### 1.18.4 (MAY) Server returns valid results for MedicationStatement search by status
<details>
...
#### 1.18.5 (SHALL) Server returns valid results for MedicationStatement search by patient + status
<details>
...
#### 1.18.6 (SHOULD) Server returns valid results for MedicationStatement search by patient + effective
<details>
...
#### 1.18.7 (SHOULD) Server returns valid results for MedicationStatement search by patient (chained parameters)
<details>
...
#### 1.18.8 (SHOULD) Server returns valid results for MedicationStatement search by patient (IHI) (chained parameters)
<details>
...
#### 1.18.9 (SHOULD) Server returns valid results for MedicationStatement search by patient (Medicare) (chained parameters)
<details>
...
#### 1.18.10 (SHOULD) Server returns valid results for MedicationStatement search by patient (DVA) (chained parameters)
<details>
...
#### 1.18.11 (SHALL) Server returns correct MedicationStatement resource from MedicationStatement read interaction
<details>
...
#### 1.19.10 (MAY) Server returns valid results for Procedure multipleAnd search by date
<details>
...
#### 1.19.11 (SHOULD) Server returns valid results for Procedure search by patient (chained parameters)
<details>
...
#### 1.19.12 (SHOULD) Server returns valid results for Procedure search by patient (IHI) (chained parameters)
<details>
...
#### 1.19.13 (SHOULD) Server returns valid results for Procedure search by patient (Medicare) (chained parameters)
<details>
...
#### 1.19.14 (SHOULD) Server returns valid results for Procedure search by patient (DVA) (chained parameters)
<details>
...
#### 1.19.15 (SHALL) Server returns correct Procedure resource from Procedure read interaction
<details>
...
#### 1.20.1 (SHALL) Server returns valid results for RelatedPerson search by patient
<details>
...
#### 1.20.2 (SHOULD) Server returns valid results for RelatedPerson search by _id
<details>
...
#### 1.20.3 (MAY) Server returns valid results for RelatedPerson search by name
<details>
...
#### 1.20.4 (MAY) Server returns valid results for RelatedPerson search by relationship
<details>
...
#### 1.20.5 (SHOULD) Server returns valid results for RelatedPerson search by patient + relationship
<details>
...
#### 1.20.6 (SHOULD) Server returns valid results for RelatedPerson search by patient + name
<details>
...
#### 1.20.7 (SHALL) Server returns correct RelatedPerson resource from RelatedPerson read interaction
<details>
...
#### 1.20.8 RelatedPerson resources returned during previous tests conform to the AU Core RelatedPerson
<details>
...
#### 1.20.9 All must support elements are provided in the RelatedPerson resources returned
<details>
...
#### 1.20.10 MustSupport references within RelatedPerson resources are valid
<details>
...
#### 1.21.1 (SHALL) Server returns correct HealthcareService resource from HealthcareService read interaction
<details>
...
#### 1.21.2 (SHALL) Server returns valid results for HealthcareService search by name
<details>
...
#### 1.21.3 (SHOULD) Server returns valid results for HealthcareService search by identifier
<details>
...
#### 1.21.4 (SHOULD) Server returns valid results for HealthcareService search by _id
<details>
...
#### 1.21.5 (SHOULD) Server returns valid results for HealthcareService search by service-type
<details>
...
#### 1.21.6 HealthcareService resources returned during previous tests conform to the AU Core HealthcareService
<details>
...
#### 1.21.7 All must support elements are provided in the HealthcareService resources returned
<details>
...
#### 1.22.1 (SHALL) Server returns correct Location resource from Location read interaction
<details>
...
#### 1.22.2 (SHOULD) Server returns valid results for Location search by address
<details>
...
#### 1.22.3 (SHALL) Server returns valid results for Location search by name
<details>
...
#### 1.22.4 (SHOULD) Server returns valid results for Location search by address-city
<details>
...
#### 1.22.5 (SHOULD) Server returns valid results for Location search by address-state
<details>
...
#### 1.22.6 (SHOULD) Server returns valid results for Location search by address-postalcode
<details>
...
#### 1.22.7 Location resources returned during previous tests conform to the AU Core Location
<details>
...
#### 1.22.8 All must support elements are provided in the Location resources returned
<details>
...
#### 1.22.9 MustSupport references within Location resources are valid
<details>
...
#### 1.23.1 (SHALL) Server returns correct Organization resource from Organization read interaction
<details>
...
#### 1.23.2 (SHOULD) Server returns valid results for Organization search by _id
<details>
...
#### 1.23.3 (SHOULD) Server returns valid results for Organization search by address
<details>
...
#### 1.23.4 (SHALL) Server returns valid results for Organization search by identifier
<details>
...
#### 1.23.5 (SHALL) Server returns valid results for Organization search by name
<details>
...
#### 1.23.6 (SHOULD) Server returns valid results for Organization search by identifier (HPI-O)
<details>
...
#### 1.23.7 (SHOULD) Server returns valid results for Organization search by identifier (ABN)
<details>
...
#### 1.23.8 Organization resources returned during previous tests conform to the AU Core Organization
<details>
...
#### 1.23.9 All must support elements are provided in the Organization resources returned
<details>
...
#### 1.24.1 (SHALL) Server returns correct Practitioner resource from Practitioner read interaction
<details>
...
#### 1.24.2 (SHOULD) Server returns valid results for Practitioner search by _id
<details>
...
#### 1.24.3 (SHALL) Server returns valid results for Practitioner search by identifier
<details>
...
#### 1.24.4 (SHOULD) Server returns valid results for Practitioner search by name
<details>
...
#### 1.24.5 (SHOULD) Server returns valid results for Practitioner search by identifier (HPI-I)
<details>
...
#### 1.24.6 Practitioner resources returned during previous tests conform to the AU Core Practitioner
<details>
...
#### 1.24.7 All must support elements are provided in the Practitioner resources returned
<details>
...
#### 1.25.1 (SHALL) Server returns correct PractitionerRole resource from PractitionerRole read interaction
<details>
...
#### 1.25.2 (SHOULD) Server returns valid results for PractitionerRole search by _id
<details>
...
#### 1.25.3 (SHALL) Server returns valid results for PractitionerRole search by identifier
<details>
...
#### 1.25.4 (SHALL) Server returns valid results for PractitionerRole search by practitioner
<details>
...
#### 1.25.5 (SHOULD) Server returns valid results for PractitionerRole search by specialty
<details>
...
#### 1.25.6 (SHOULD) Server returns valid results for PractitionerRole search by role
<details>
...
#### 1.25.7 (MAY) Server returns valid results for PractitionerRole search by organization
<details>
...
#### 1.25.8 (MAY) Server returns valid results for PractitionerRole multipleOr search by practitioner
<details>
...
#### 1.25.9 (MAY) Server returns valid results for PractitionerRole multipleAnd search by practitioner
<details>
...
#### 1.25.10 (SHOULD) Server returns valid results for PractitionerRole search by practitioner (chained parameters)
<details>
...
#### 1.25.11 (SHOULD) Server returns valid results for PractitionerRole search by identifier (Medicare)
<details>
...
#### 1.25.12 Server returns Practitioner resources from PractitionerRole search by _id and PractitionerRole:practitioner
<details>
...
#### 1.25.13 Server returns Practitioner resources from PractitionerRole search by identifier and PractitionerRole:practitioner
<details>
...
#### 1.25.14 Server returns Practitioner resources from PractitionerRole search by practitioner and PractitionerRole:practitioner
<details>
...
#### 1.25.15 Server returns Practitioner resources from PractitionerRole search by specialty and PractitionerRole:practitioner
<details>
...
#### 1.25.16 PractitionerRole resources returned during previous tests conform to the AU Core PractitionerRole
<details>
...
#### 1.25.17 All must support elements are provided in the PractitionerRole resources returned
<details>
...
#### 1.25.18 MustSupport references within PractitionerRole resources are valid
<details>
