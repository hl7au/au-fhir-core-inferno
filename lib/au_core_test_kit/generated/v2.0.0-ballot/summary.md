...
#### 2.21.1 (SHALL) Server returns correct HealthcareService resource from HealthcareService read interaction
<details>
...
#### 2.21.2 (SHALL) Server returns valid results for HealthcareService search by name
<details>
...
#### 2.21.3 (SHOULD) Server returns valid results for HealthcareService search by identifier
<details>
...
#### 2.21.4 (SHOULD) Server returns valid results for HealthcareService search by _id
<details>
...
#### 2.21.5 (SHOULD) Server returns valid results for HealthcareService search by service-type
<details>
...
#### 2.21.6 HealthcareService resources returned during previous tests conform to the AU Core HealthcareService
<details>
...
#### 2.21.7 All must support elements are provided in the HealthcareService resources returned
<details>
...
#### 2.22.1 (SHALL) Server returns correct Location resource from Location read interaction
<details>
...
#### 2.22.2 (SHOULD) Server returns valid results for Location search by address
<details>
...
#### 2.22.3 (SHALL) Server returns valid results for Location search by name
<details>
...
#### 2.22.4 (SHOULD) Server returns valid results for Location search by address-city
<details>
...
#### 2.22.5 (SHOULD) Server returns valid results for Location search by address-state
<details>
...
#### 2.22.6 (SHOULD) Server returns valid results for Location search by address-postalcode
<details>
...
#### 2.22.7 Location resources returned during previous tests conform to the AU Core Location
<details>
...
#### 2.22.8 All must support elements are provided in the Location resources returned
<details>
...
#### 2.22.9 MustSupport references within Location resources are valid
<details>
...
#### 2.23.1 (SHALL) Server returns correct Organization resource from Organization read interaction
<details>
...
#### 2.23.2 (SHOULD) Server returns valid results for Organization search by _id
<details>
...
#### 2.23.3 (SHOULD) Server returns valid results for Organization search by address
<details>
...
#### 2.23.4 (SHALL) Server returns valid results for Organization search by identifier
<details>
...
#### 2.23.5 (SHALL) Server returns valid results for Organization search by name
<details>
...
#### 2.23.6 (SHOULD) Server returns valid results for Organization search by identifier (HPI-O)
<details>
...
#### 2.23.7 (SHOULD) Server returns valid results for Organization search by identifier (ABN)
<details>
...
#### 2.23.8 Organization resources returned during previous tests conform to the AU Core Organization
<details>
...
#### 2.23.9 All must support elements are provided in the Organization resources returned
<details>
...
#### 2.24.1 (SHALL) Server returns correct Practitioner resource from Practitioner read interaction
<details>
...
#### 2.24.2 (SHOULD) Server returns valid results for Practitioner search by _id
<details>
...
#### 2.24.3 (SHALL) Server returns valid results for Practitioner search by identifier
<details>
...
#### 2.24.4 (SHOULD) Server returns valid results for Practitioner search by name
<details>
...
#### 2.24.5 (SHOULD) Server returns valid results for Practitioner search by identifier (HPI-I)
<details>
...
#### 2.24.6 Practitioner resources returned during previous tests conform to the AU Core Practitioner
<details>
...
#### 2.24.7 All must support elements are provided in the Practitioner resources returned
<details>
...
#### 2.25.1 (SHALL) Server returns correct PractitionerRole resource from PractitionerRole read interaction
<details>
...
#### 2.25.2 (SHOULD) Server returns valid results for PractitionerRole search by _id
<details>
...
#### 2.25.3 (SHALL) Server returns valid results for PractitionerRole search by identifier
<details>
...
#### 2.25.4 (SHALL) Server returns valid results for PractitionerRole search by practitioner
<details>
...
#### 2.25.5 (SHOULD) Server returns valid results for PractitionerRole search by specialty
<details>
...
#### 2.25.6 (SHOULD) Server returns valid results for PractitionerRole search by role
<details>
...
#### 2.25.7 (MAY) Server returns valid results for PractitionerRole search by organization
<details>
...
#### 2.25.8 (MAY) Server returns valid results for PractitionerRole multipleOr search by practitioner
<details>
...
#### 2.25.9 (MAY) Server returns valid results for PractitionerRole multipleAnd search by practitioner
<details>
...
#### 2.25.10 (SHOULD) Server returns valid results for PractitionerRole search by practitioner (chained parameters)
<details>
...
#### 2.25.11 (SHOULD) Server returns valid results for PractitionerRole search by identifier (Medicare)
<details>
...
#### 2.25.12 Server returns Practitioner resources from PractitionerRole search by _id and PractitionerRole:practitioner
<details>
...
#### 2.25.13 Server returns Practitioner resources from PractitionerRole search by identifier and PractitionerRole:practitioner
<details>
...
#### 2.25.14 Server returns Practitioner resources from PractitionerRole search by practitioner and PractitionerRole:practitioner
<details>
...
#### 2.25.15 Server returns Practitioner resources from PractitionerRole search by specialty and PractitionerRole:practitioner
<details>
...
#### 2.25.16 PractitionerRole resources returned during previous tests conform to the AU Core PractitionerRole
<details>
...
#### 2.25.17 All must support elements are provided in the PractitionerRole resources returned
<details>
...
#### 2.25.18 MustSupport references within PractitionerRole resources are valid
<details>
