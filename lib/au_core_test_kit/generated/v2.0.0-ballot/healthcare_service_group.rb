...
read succeeds.
      ...
      id :au_core_v200_ballot_healthcare_service
      run_as_group
      ...
      test from: :au_core_v200_ballot_healthcare_service_read_test
      test from: :au_core_v200_ballot_healthcare_service_name_search_test
      test from: :au_core_v200_ballot_healthcare_service_identifier_search_test
      test from: :au_core_v200_ballot_healthcare_service__id_search_test
      test from: :au_core_v200_ballot_healthcare_service_service_type_search_test
      test from: :au_core_v200_ballot_healthcare_service_validation_test
      test from: :au_core_v200_ballot_healthcare_service_must_support_test
    end
  end
end
