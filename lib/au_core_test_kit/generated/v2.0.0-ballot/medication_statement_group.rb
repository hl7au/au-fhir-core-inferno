...
read succeeds.
      ...
      id :au_core_v200_ballot_medication_statement
      run_as_group
      ...
      test from: :au_core_v200_ballot_medication_statement_patient_search_test
      test from: :au_core_v200_ballot_medication_statement__id_search_test
      test from: :au_core_v200_ballot_medication_statement_effective_search_test
      test from: :au_core_v200_ballot_medication_statement_status_search_test
      test from: :au_core_v200_ballot_medication_statement_patient_status_search_test
      test from: :au_core_v200_ballot_medication_statement_patient_effective_search_test
      test from: :au_core_v200_ballot_medication_statement_patient_chain_search_test
      test from: :au_core_v200_ballot_medication_statement_patient_ihi_chain_search_test
      test from: :au_core_v200_ballot_medication_statement_patient_medicare_chain_search_test
      test from: :au_core_v200_ballot_medication_statement_patient_dva_chain_search_test
      test from: :au_core_v200_ballot_medication_statement_read_test
      test from: :au_core_v200_ballot_medication_statement_validation_test
      test from: :au_core_v200_ballot_medication_statement_must_support_test
      test from: :au_core_v200_ballot_medication_statement_reference_resolution_test
    end
  end
end
