  ...
  module AUCoreV200_BALLOT
    class AUCoreTestSuite < Inferno::TestSuite
      ...
      description %(
        ...
        Implementation Guide](https://hl7.org.au/fhir/core/2.0.0-ballot).
      ...
      fhir_resource_validator do
        igs 'hl7.fhir.au.core#2.0.0-ballot'
      ...
      group do
        ...
        id :au_core_v200_ballot_fhir_api

        group from: :au_core_v030_ballot_capability_statement

        group from: :au_core_v200_ballot_patient

        group from: :au_core_v200_ballot_bodyweight

        group from: :au_core_v200_ballot_bloodpressure

        group from: :au_core_v200_ballot_bodyheight

        group from: :au_core_v200_ballot_diagnosticresult_path

        group from: :au_core_v200_ballot_bodytemp

        group from: :au_core_v200_ballot_heartrate

        group from: :au_core_v200_ballot_waistcircum

        group from: :au_core_v200_ballot_resprate

        group from: :au_core_v200_ballot_diagnosticresult

        group from: :au_core_v200_ballot_smokingstatus

        group from: :au_core_v200_ballot_allergy_intolerance

        group from: :au_core_v200_ballot_condition

        group from: :au_core_v200_ballot_encounter

        group from: :au_core_v200_ballot_immunization

        group from: :au_core_v200_ballot_medication_request

        group from: :au_core_v200_ballot_medication_statement

        group from: :au_core_v200_ballot_procedure

        group from: :au_core_v200_ballot_related_person

        group from: :au_core_v200_ballot_healthcare_service

        group from: :au_core_v200_ballot_location

        group from: :au_core_v200_ballot_organization

        group from: :au_core_v200_ballot_practitioner

        group from: :au_core_v200_ballot_practitioner_role
