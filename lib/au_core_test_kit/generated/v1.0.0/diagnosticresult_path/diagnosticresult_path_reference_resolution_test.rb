...
module AUCoreTestKit
  module AUCoreV100
    class DiagnosticresultPathReferenceResolutionTest < Inferno::Test
      ...
      id :au_core_v100_diagnosticresult_path_reference_resolution_test
      ...
      run do
        perform_reference_resolution_test(
          ...
          %w[AllergyIntolerance Condition Encounter Immunization Location Medication MedicationRequest Observation Organization Patient Practitioner PractitionerRole Procedure]
        )
      end
    end
  end
