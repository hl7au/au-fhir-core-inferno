...
#### 3.18.2 (MAY) Server returns valid results for Procedure search by code
<details>
...
#### 3.18.3 (MAY) Server returns valid results for Procedure search by date
<details>
...
#### 3.18.4 (MAY) Server returns valid results for Procedure search by status
<details>
...
#### 3.18.5 (SHALL) Server returns valid results for Procedure search by patient + date
<details>
...
#### 3.18.6 (SHOULD) Server returns valid results for Procedure search by patient + code + date
<details>
...
#### 3.18.7 (SHOULD) Server returns valid results for Procedure search by patient + status
<details>
...
#### 3.18.8 (SHOULD) Server returns valid results for Procedure multipleOr search by code
<details>
...
#### 3.18.9 (SHOULD) Server returns valid results for Procedure multipleOr search by status
<details>
...
#### 3.19.2 (SHOULD) Server returns valid results for Location search by address
<details>
...
#### 3.20.5 (SHALL) Server returns valid results for Organization search by name
<details>
...
#### 3.21.2 (SHOULD) Server returns valid results for Practitioner search by _id
<details>
...
#### 3.22.2 (SHOULD) Server returns valid results for PractitionerRole search by _id
<details>
...
#### 3.22.6 (SHOULD) Server returns valid results for PractitionerRole search by role
<details>
...
#### 3.22.7 (MAY) Server returns valid results for PractitionerRole search by organization
<details>
...
#### 3.22.8 (MAY) Server returns valid results for PractitionerRole multipleOr search by practitioner
<details>
...
#### 3.22.9 (MAY) Server returns valid results for PractitionerRole multipleAnd search by practitioner
<details>
...
#### 3.22.10 (SHOULD) Server returns valid results for PractitionerRole search by practitioner (chained parameters)
<details>
...
#### 3.22.11 (SHOULD) Server returns valid results for PractitionerRole search by identifier (Medicare)
<details>
...
#### 3.22.12 Server returns Practitioner resources from PractitionerRole search by _id and PractitionerRole:practitioner
<details>
...
#### 3.22.13 Server returns Practitioner resources from PractitionerRole search by identifier and PractitionerRole:practitioner
<details>
...
#### 3.22.14 Server returns Practitioner resources from PractitionerRole search by practitioner and PractitionerRole:practitioner
<details>
...
#### 3.22.15 Server returns Practitioner resources from PractitionerRole search by specialty and PractitionerRole:practitioner
<details>
...
#### 3.22.16 PractitionerRole resources returned during previous tests conform to the AU Core PractitionerRole
<details>
...
#### 3.22.17 All must support elements are provided in the PractitionerRole resources returned
<details>
...
#### 3.22.18 MustSupport references within PractitionerRole resources are valid
<details>
