  ...
  module AUCoreV100
    class AUCoreTestSuite < Inferno::TestSuite
      ...
      group do
        ...
        id :au_core_v100_fhir_api

        group from: :au_core_v030_ballot_capability_statement

        group from: :au_core_v100_patient

        group from: :au_core_v100_bodyweight

        group from: :au_core_v100_bloodpressure

        group from: :au_core_v100_bodyheight

        group from: :au_core_v100_diagnosticresult_path

        group from: :au_core_v100_bodytemp

        group from: :au_core_v100_heartrate

        group from: :au_core_v100_waistcircum

        group from: :au_core_v100_resprate

        group from: :au_core_v100_diagnosticresult

        group from: :au_core_v100_smokingstatus

        group from: :au_core_v100_allergy_intolerance

        group from: :au_core_v100_condition

        group from: :au_core_v100_encounter

        group from: :au_core_v100_immunization

        group from: :au_core_v100_medication_request

        group from: :au_core_v100_procedure

        group from: :au_core_v100_location

        group from: :au_core_v100_organization

        group from: :au_core_v100_practitioner

        group from: :au_core_v100_practitioner_role
