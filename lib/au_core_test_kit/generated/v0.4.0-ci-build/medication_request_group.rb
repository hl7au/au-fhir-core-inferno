...
read succeeds.
      ...
      id :au_core_v040_ci_build_medication_request
      run_as_group
      ...
      test from: :au_core_v040_ci_build_medication_request_patient_intent_search_test
      test from: :au_core_v040_ci_build_medication_request_patient_intent_status_search_test
      test from: :au_core_v040_ci_build_medication_request_patient_intent_authoredon_search_test
      test from: :au_core_v040_ci_build_medication_request_intent_multiple_or_search_test
      test from: :au_core_v040_ci_build_medication_request_status_multiple_or_search_test
      ...
      test from: :au_core_v040_ci_build_medication_request_patient_ihi_chain_search_test
      test from: :au_core_v040_ci_build_medication_request_patient_medicare_chain_search_test
      test from: :au_core_v040_ci_build_medication_request_patient_dva_chain_search_test
      ...
      test from: :au_core_v040_ci_build_medication_request_reference_resolution_test
    end
  end
end
