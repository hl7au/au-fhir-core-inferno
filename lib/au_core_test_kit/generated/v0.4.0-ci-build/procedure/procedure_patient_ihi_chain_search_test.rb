...
module AUCoreTestKit
  module AUCoreV040_CI_BUILD
    class ProcedurePatient_IHI_ChainSearchTest < Inferno::Test
      ...
      title 'Server returns valid results for Procedure search by patient (IHI) (chained parameters)'
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core//CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v040_ci_build_procedure_patient_ihi_chain_search_test
