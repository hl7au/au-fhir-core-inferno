...
module AUCoreTestKit
  module AUCoreV040_CI_BUILD
    class ConditionPatient_IHI_ChainSearchTest < Inferno::Test
      ...
      title %(Server returns valid results for Condition search by patient (IHI) (chained parameters))
...
[AU Core Server CapabilityStatement](http://hl7.org.au/fhir/core//CapabilityStatement-au-core-server.html)
      ...
      id :au_core_v040_ci_build_condition_patient_ihi_chain_search_test
