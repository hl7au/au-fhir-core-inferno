...
read succeeds.
      ...
      id :au_core_v040_ci_build_provenance
      run_as_group
      ...
      test from: :au_core_v040_ci_build_provenance_read_test
      test from: :au_core_v040_ci_build_provenance_validation_test
      test from: :au_core_v040_ci_build_provenance_must_support_test
      test from: :au_core_v040_ci_build_provenance_reference_resolution_test
    end
  end
end
