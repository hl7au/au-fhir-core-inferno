...
#### 4.15.4 (MAY) Server returns valid results for Encounter search by identifier
<details>
...
#### 4.15.5 (MAY) Server returns valid results for Encounter search by location
<details>
...
#### 4.15.6 (MAY) Server returns valid results for Encounter search by status
<details>
...
#### 4.15.7 (SHALL) Server returns valid results for Encounter search by date + patient
<details>
...
#### 4.15.8 (SHOULD) Server returns valid results for Encounter search by class + patient
<details>
...
#### 4.15.9 (SHOULD) Server returns valid results for Encounter search by patient + location
<details>
...
#### 4.15.10 (SHOULD) Server returns valid results for Encounter search by patient + status
<details>
