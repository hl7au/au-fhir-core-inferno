...
#### 3.15.4 (MAY) Server returns valid results for Encounter search by identifier
<details>
...
#### 3.15.5 (MAY) Server returns valid results for Encounter search by location
<details>
...
#### 3.15.6 (MAY) Server returns valid results for Encounter search by status
<details>
...
#### 3.15.7 (SHALL) Server returns valid results for Encounter search by date + patient
<details>
...
#### 3.15.8 (SHOULD) Server returns valid results for Encounter search by class + patient
<details>
...
#### 3.15.9 (SHOULD) Server returns valid results for Encounter search by patient + location
<details>
...
#### 3.15.10 (SHOULD) Server returns valid results for Encounter search by patient + status
<details>
...
#### 3.17.17 MedicationRequest resources returned during previous tests conform to the AU Core MedicationRequest
<details>
...
#### 3.17.18 Medication resources returned during previous tests conform to the AU Core Medication
<details>
...
#### 3.17.19 All must support elements are provided in the MedicationRequest resources returned
<details>
...
#### 3.17.20 MustSupport references within MedicationRequest resources are valid
<details>
...
#### 3.22.11 PractitionerRole resources returned during previous tests conform to the AU Core PractitionerRole
<details>
...
#### 3.22.12 All must support elements are provided in the PractitionerRole resources returned
<details>
...
#### 3.22.13 MustSupport references within PractitionerRole resources are valid
<details>
