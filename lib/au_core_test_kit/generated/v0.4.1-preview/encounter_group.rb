...
read succeeds.
      ...
      id :au_core_v041_preview_encounter
      run_as_group
      ...
      test from: :au_core_v041_preview_encounter_patient_status_search_test
      test from: :au_core_v041_preview_encounter_date_multiple_and_search_test
      test from: :au_core_v041_preview_encounter_patient_chain_search_test
      test from: :au_core_v041_preview_encounter_patient_ihi_chain_search_test
      test from: :au_core_v041_preview_encounter_patient_medicare_chain_search_test
      test from: :au_core_v041_preview_encounter_patient_dva_chain_search_test
      test from: :au_core_v041_preview_encounter_read_test
      test from: :au_core_v041_preview_encounter_validation_test
      test from: :au_core_v041_preview_encounter_must_support_test
      test from: :au_core_v041_preview_encounter_reference_resolution_test
    end
  end
end
