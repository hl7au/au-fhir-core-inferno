...
read succeeds.
      ...
      id :au_core_v100_ci_build_patient
      run_as_group
      ...
      test from: :au_core_v100_ci_build_patient__id_search_test
      test from: :au_core_v100_ci_build_patient_birthdate_search_test
      test from: :au_core_v100_ci_build_patient_family_search_test
      test from: :au_core_v100_ci_build_patient_gender_search_test
      test from: :au_core_v100_ci_build_patient_indigenous_status_search_test
      test from: :au_core_v100_ci_build_patient_identifier_search_test
      test from: :au_core_v100_ci_build_patient_name_search_test
      test from: :au_core_v100_ci_build_patient_gender_identity_search_test
      test from: :au_core_v100_ci_build_patient_birthdate_family_search_test
      test from: :au_core_v100_ci_build_patient_birthdate_name_search_test
      test from: :au_core_v100_ci_build_patient_family_gender_search_test
      ...
      test from: :au_core_v100_ci_build_patient_identifier_medicare_search_test
      test from: :au_core_v100_ci_build_patient_identifier_dva_search_test
      test from: :au_core_v100_ci_build_patient_read_test
      test from: :au_core_v100_ci_build_patient_validation_test
      test from: :au_core_v100_ci_build_patient_must_support_test
    end
  end
end
