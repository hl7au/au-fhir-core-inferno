...
read succeeds.
      ...
      id :au_core_v100_ci_build_location
      run_as_group
      ...
      test from: :au_core_v100_ci_build_location_read_test
      test from: :au_core_v100_ci_build_location_address_search_test
      test from: :au_core_v100_ci_build_location_name_search_test
      test from: :au_core_v100_ci_build_location_address_city_search_test
      test from: :au_core_v100_ci_build_location_address_state_search_test
      test from: :au_core_v100_ci_build_location_address_postalcode_search_test
      test from: :au_core_v100_ci_build_location_identifier_search_test
      test from: :au_core_v100_ci_build_location_validation_test
      test from: :au_core_v100_ci_build_location_must_support_test
      test from: :au_core_v100_ci_build_location_reference_resolution_test
    end
  end
end
