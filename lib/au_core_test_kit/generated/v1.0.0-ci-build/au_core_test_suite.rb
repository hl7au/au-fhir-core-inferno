  ...
  module AUCoreV100_CI_BUILD
    class AUCoreTestSuite < Inferno::TestSuite
      ...
      fhir_resource_validator do
        igs 'hl7.fhir.au.core#1.0.0-ci-build'
      ...
      group do
        ...
        id :au_core_v100_ci_build_fhir_api

        group from: :au_core_v030_ballot_capability_statement

        group from: :au_core_v100_ci_build_patient

        group from: :au_core_v100_ci_build_bodyweight

        group from: :au_core_v100_ci_build_bloodpressure

        group from: :au_core_v100_ci_build_bodyheight

        group from: :au_core_v100_ci_build_diagnosticresult_path

        group from: :au_core_v100_ci_build_bodytemp

        group from: :au_core_v100_ci_build_heartrate

        group from: :au_core_v100_ci_build_waistcircum

        group from: :au_core_v100_ci_build_resprate

        group from: :au_core_v100_ci_build_diagnosticresult

        group from: :au_core_v100_ci_build_smokingstatus

        group from: :au_core_v100_ci_build_allergy_intolerance

        group from: :au_core_v100_ci_build_condition

        group from: :au_core_v100_ci_build_encounter

        group from: :au_core_v100_ci_build_immunization

        group from: :au_core_v100_ci_build_medication_request

        group from: :au_core_v100_ci_build_procedure

        group from: :au_core_v100_ci_build_location

        group from: :au_core_v100_ci_build_organization

        group from: :au_core_v100_ci_build_practitioner

        group from: :au_core_v100_ci_build_practitioner_role
