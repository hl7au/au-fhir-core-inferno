...
read succeeds.
      ...
      id :au_core_v100_ci_build_bodytemp
      run_as_group
      ...
      test from: :au_core_v100_ci_build_bodytemp_patient_category_status_search_test
      test from: :au_core_v100_ci_build_bodytemp_patient_code_date_search_test
      test from: :au_core_v100_ci_build_bodytemp_code_multiple_or_search_test
      test from: :au_core_v100_ci_build_bodytemp_status_multiple_or_search_test
      test from: :au_core_v100_ci_build_bodytemp_date_multiple_and_search_test
      test from: :au_core_v100_ci_build_bodytemp_patient_chain_search_test
      test from: :au_core_v100_ci_build_bodytemp_patient_ihi_chain_search_test
      test from: :au_core_v100_ci_build_bodytemp_patient_medicare_chain_search_test
      test from: :au_core_v100_ci_build_bodytemp_patient_dva_chain_search_test
      test from: :au_core_v100_ci_build_bodytemp_read_test
      test from: :au_core_v100_ci_build_bodytemp_validation_test
      test from: :au_core_v100_ci_build_bodytemp_must_support_test
      test from: :au_core_v100_ci_build_bodytemp_reference_resolution_test
    end
  end
end
