...
read succeeds.
      ...
      test from: :au_core_v100_ci_build_diagnosticresult_patient_code_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_category_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_code_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_date_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_status_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_patient_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_patient_category_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_patient_category_date_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_patient_category_status_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_patient_code_date_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_code_multiple_or_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_status_multiple_or_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_date_multiple_and_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_patient_chain_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_patient_ihi_chain_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_patient_medicare_chain_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_patient_dva_chain_search_test
      test from: :au_core_v100_ci_build_diagnosticresult_read_test
      test from: :au_core_v100_ci_build_diagnosticresult_validation_test
      test from: :au_core_v100_ci_build_diagnosticresult_must_support_test
      test from: :au_core_v100_ci_build_diagnosticresult_reference_resolution_test
    end
  end
end
