...
read succeeds.
      ...
      id :au_core_v100_ci_build_waistcircum
      run_as_group
      ...
      test from: :au_core_v100_ci_build_waistcircum_patient_code_search_test
      test from: :au_core_v100_ci_build_waistcircum_category_search_test
      test from: :au_core_v100_ci_build_waistcircum_code_search_test
      test from: :au_core_v100_ci_build_waistcircum_date_search_test
      test from: :au_core_v100_ci_build_waistcircum_status_search_test
      test from: :au_core_v100_ci_build_waistcircum_patient_search_test
      test from: :au_core_v100_ci_build_waistcircum_patient_category_search_test
      test from: :au_core_v100_ci_build_waistcircum_patient_category_date_search_test
      test from: :au_core_v100_ci_build_waistcircum_patient_category_status_search_test
      test from: :au_core_v100_ci_build_waistcircum_patient_code_date_search_test
      test from: :au_core_v100_ci_build_waistcircum_code_multiple_or_search_test
      test from: :au_core_v100_ci_build_waistcircum_status_multiple_or_search_test
      test from: :au_core_v100_ci_build_waistcircum_date_multiple_and_search_test
      test from: :au_core_v100_ci_build_waistcircum_patient_chain_search_test
      test from: :au_core_v100_ci_build_waistcircum_patient_ihi_chain_search_test
      test from: :au_core_v100_ci_build_waistcircum_patient_medicare_chain_search_test
      test from: :au_core_v100_ci_build_waistcircum_patient_dva_chain_search_test
      test from: :au_core_v100_ci_build_waistcircum_read_test
      test from: :au_core_v100_ci_build_waistcircum_validation_test
      test from: :au_core_v100_ci_build_waistcircum_must_support_test
      test from: :au_core_v100_ci_build_waistcircum_reference_resolution_test
    end
  end
end
