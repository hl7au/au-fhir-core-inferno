...
module AUCoreTestKit
  class Generator
    class MustSupportMetadataExtractorAUCore4
      ...
      def au_core_3_extractor
        @au_core_3_extractor ||= MustSupportMetadataExtractorAUCore3.new(profile, must_supports)
      end
      ...
      def remove_patient_address_period
        au_core_3_extractor.remove_patient_address_period
      end

      def add_device_distinct_identifier
        if profile.type == 'Device'
          # FHIR-36303 AU Core 4.0.0 mistakenly removed MS from Device.distinctIdentifier
          # This will be fixed in AU Core 5.0.0
      ...
      def add_patient_uscdi_elements
        ...
        #AU Core 4.0.0 Section 10.112.1.1 Additional USCDI v1 Requirement:
      ...
      def add_patient_telecom_communication_uscdi
        ...
        # Though telecom.system, telecom.value, telecom.use, and communication.language are marked as MustSupport since AU Core v4.0.0,
