...
module USCoreTestKit
  module USCoreV030
    class AuCoreDiagnosticReportProvenanceRevincludeSearchTest < Inferno::Test
      include USCoreTestKit::SearchTest

      title 'Server returns Provenance resources from DiagnosticReport search by patient + revInclude:Provenance:target'
      description %(
      ...
      id :us_core_v030_au_core_diagnostic_report_provenance_revinclude_search_test
