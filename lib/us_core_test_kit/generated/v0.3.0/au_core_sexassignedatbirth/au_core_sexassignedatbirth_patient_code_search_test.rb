...
module USCoreTestKit
  module USCoreV030
    class AuCoreSexassignedatbirthPatientCodeSearchTest < Inferno::Test
...
requirement of US Core v0.3.0.

[US Core Server CapabilityStatement](http://hl7.org/fhir/us/core//CapabilityStatement-us-core-server.html)

      )

      id :us_core_v030_au_core_sexassignedatbirth_patient_code_search_test
      optional
