...
The US Core AU Core Encounter sequence verifies that the system under test is
...
read succeeds.
      ...
      test from: :us_core_v030_encounter_patient_search_test
      test from: :us_core_v030_encounter_date_patient_search_test
      test from: :us_core_v030_encounter_class_patient_search_test
      test from: :us_core_v030_encounter_patient_location_search_test
      test from: :us_core_v030_encounter_patient_status_search_test
      test from: :us_core_v030_encounter_patient_type_search_test
      test from: :us_core_v030_encounter_read_test
      test from: :us_core_v030_encounter_provenance_revinclude_search_test
      test from: :us_core_v030_encounter_validation_test
      test from: :us_core_v030_encounter_must_support_test
      test from: :us_core_v030_encounter_reference_resolution_test
    end
  end
end
