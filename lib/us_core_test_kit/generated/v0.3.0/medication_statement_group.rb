...
The US Core AU Core MedicationStatement sequence verifies that the system under test is
...
read succeeds.
      ...
      id :us_core_v030_medication_statement
      run_as_group
      ...
      test from: :us_core_v030_medication_statement_patient_search_test
      test from: :us_core_v030_medication_statement_patient_status_search_test
      test from: :us_core_v030_medication_statement_patient_effective_search_test
      test from: :us_core_v030_medication_statement_read_test
      test from: :us_core_v030_medication_statement_provenance_revinclude_search_test
      test from: :us_core_v030_medication_statement_validation_test
      test from: :us_core_v030_medication_statement_must_support_test
      test from: :us_core_v030_medication_statement_reference_resolution_test
    end
  end
end
