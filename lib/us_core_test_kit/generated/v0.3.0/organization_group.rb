...
The US Core AU Core Organization sequence verifies that the system under test is
...
read succeeds.
      ...
      test from: :us_core_v030_organization_read_test
      test from: :us_core_v030_organization_address_search_test
      test from: :us_core_v030_organization_identifier_search_test
      test from: :us_core_v030_organization_name_search_test
      test from: :us_core_v030_organization__id_search_test
      test from: :us_core_v030_organization_provenance_revinclude_search_test
      test from: :us_core_v030_organization_validation_test
      test from: :us_core_v030_organization_must_support_test
    end
  end
end
