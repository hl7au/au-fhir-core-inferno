...
module USCoreTestKit
  module USCoreV030
    class AuCoreDiagnosticresultImagProvenanceRevincludeSearchTest < Inferno::Test
      ...
      id :us_core_v030_au_core_diagnosticresult_imag_provenance_revinclude_search_test
